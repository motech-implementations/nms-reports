...
package final_etl.ma_mk_data_0_2;
...
/**
 * Job: MA_MK_Data Purpose: MA_MK_Data<br>
 * Description: MA_MK_Data <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class MA_MK_Data implements TalendJob {
	...
	private final String jobName = "MA_MK_Data";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MA_MK_Data.this, new Object[] { e,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.circle_dimension_0_1.Circle_Dimension childJob_tRunJob_1 = new final_etl.circle_dimension_0_1.Circle_Dimension();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.frontlineworker_0_1.FrontLineWorker childJob_tRunJob_2 = new final_etl.frontlineworker_0_1.FrontLineWorker();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.ma_dimension_0_1.MA_Dimension childJob_tRunJob_6 = new final_etl.ma_dimension_0_1.MA_Dimension();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.mk_call_detail_0_1.MK_Call_Detail childJob_tRunJob_3 = new final_etl.mk_call_detail_0_1.MK_Call_Detail();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.ma_call_detail_0_1.MA_Call_Detail childJob_tRunJob_4 = new final_etl.ma_call_detail_0_1.MA_Call_Detail();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.ma_course_completion_0_1.MA_Course_Completion childJob_tRunJob_5 = new final_etl.ma_course_completion_0_1.MA_Course_Completion();
				// pass DataSources
	...
	public static void main(String[] args) {
		final MA_MK_Data MA_MK_DataClass = new MA_MK_Data();

		int exitCode = MA_MK_DataClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MA_MK_Data.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/ma_mk_data_0_2/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MA_MK_Data");
		}
...
/************************************************************************************************
 * 52311 characters generated by Talend Open Studio for Big Data on the 18 July,
 * 2016 4:07:54 PM IST
 ************************************************************************************************/
