...
package final_etl.ma_mk_etl_job_0_2;
...
/**
 * Job: MA_MK_ETL_JOB Purpose: MA_MK_ETL_JOB<br>
 * Description: MA_MK_ETL_JOB <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class MA_MK_ETL_JOB implements TalendJob {
	...
	private final String jobName = "MA_MK_ETL_JOB";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MA_MK_ETL_JOB.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MA_MK_ETL_JOB.this, new Object[] { e,
	...
	public void tJava_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("MA/MK ETL Started......................");
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info childJob_tRunJob_1 = new final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.ma_mk_data_0_2.MA_MK_Data childJob_tRunJob_2 = new final_etl.ma_mk_data_0_2.MA_MK_Data();
				// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println(new java.text.SimpleDateFormat(
						"yyyy-MM-dd HH:mm:ss").format(java.util.Calendar
						.getInstance().getTime()));
				System.out.println("MA/MK ETL Ended......................");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println(new java.text.SimpleDateFormat(
						...
						.getInstance().getTime()));
				System.out
						.println("Error occured in MA/MK ETL execution, Please Refer log printed above");
	...
	public static void main(String[] args) {
		final MA_MK_ETL_JOB MA_MK_ETL_JOBClass = new MA_MK_ETL_JOB();

		int exitCode = MA_MK_ETL_JOBClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MA_MK_ETL_JOB.class
					.getClassLoader().getResourceAsStream(
							"final_etl/ma_mk_etl_job_0_2/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MA_MK_ETL_JOB");
		}
...
/************************************************************************************************
 * 48613 characters generated by Talend Open Studio for Big Data on the 18 July,
 * 2016 4:07:54 PM IST
 ************************************************************************************************/
