...
package final_etl.ma_dimension_0_1;
...
/**
 * Job: MA_Dimension Purpose: MA_Dimension<br>
 * Description: MA_Dimension <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class MA_Dimension implements TalendJob {
	...
	private final String jobName = "MA_Dimension";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MA_Dimension.this, new Object[] { e,
	...
	public static class row1Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Dimension = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_MA_Dimension.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_MA_Dimension.length == 0) {
						commonByteArray_FINAL_ETL_MA_Dimension = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_MA_Dimension = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_MA_Dimension, 0, length);
				strReturn = new String(commonByteArray_FINAL_ETL_MA_Dimension,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_MA_Dimension) {
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "INSERT INTO `ma_dimension` (`id`,`content_name`,`file_name`,`type`,`duration`) \nVALUES (1,'Chapter01_Lesson01','ch1_l1.wav','NULL',120),\n(2,'Chapter01_Lesson02','ch1_l2.wav','NULL',120),\n(3,'Chapter02_Lesson01','ch2_l1.wav','NULL',120),\n(4,'Chapter02_Lesson02','ch2_l2.wav','NULL',120),\n(5,'Chapter02_Lesson03','ch2_l3.wav','NULL',120),\n(6,'Chapter02_Question01','ch2_q1.wav','NULL',120),\n(7,'Chapter02_Question02','ch2_q2.wav','NULL',120),\n(8,'Chapter02_Question03','ch2_q3.wav','NULL',120),\n(9,'Chapter02_Question04','ch2_q4.wav','NULL',120),\n(10,'Chapter03_Lesson01','ch3_l1.wav','NULL',120),\n(11,'Chapter01_Lesson03','ch1_l3.wav','NULL',120),\n(12,'Chapter01_Lesson04','ch1_l4.wav','NULL',120),\n(13,'Chapter01_Question01','ch1_q1.wav','NULL',120),\n(14,'Chapter01_Question02','ch1_q2.wav','NULL',120),\n(15,'Chapter01_Question03','ch1_q3.wav','NULL',120),\n(16,'Chapter01_Question04','ch1_q4.wav','NULL',120),\n(17,'Chapter07_Lesson03','ch7_l3.wav','NULL',120),\n(18,'Chapter07_Lesson04','ch7_l4.wav','NULL',120),\n(19,'Chapter02_Lesson04','ch2_l4.wav','NULL',120),\n(20,'Chapter09_Question03','ch9_q3.wav','NULL',120),\n(21,'Chapter09_Question04','ch9_q4.wav','NULL',120),\n(22,'Chapter10_Lesson01','ch10_l1.wav','NULL',120),\n(23,'Chapter10_Lesson02','ch10_l2.wav','NULL',120),\n(24,'Chapter10_Lesson03','ch10_l3.wav','NULL',120),\n(25,'Chapter10_Lesson04','ch10_l4.wav','NULL',120),\n(26,'Chapter10_Question01','ch10_q1.wav','NULL',120),\n(27,'Chapter10_Question02','ch10_q2.wav','NULL',120),\n(28,'Chapter03_Lesson02','ch3_l2.wav','NULL',120),\n(29,'Chapter03_Lesson03','ch3_l3.wav','NULL',120),\n(30,'Chapter03_Lesson04','ch3_l4.wav','NULL',120),\n(31,'Chapter03_Question01','ch3_q1.wav','NULL',120),\n(32,'Chapter03_Question02','ch3_q2.wav','NULL',120),\n(33,'Chapter03_Question03','ch3_q3.wav','NULL',120),\n(34,'Chapter03_Question04','ch3_q4.wav','NULL',120),\n(35,'Chapter04_Lesson01','ch4_l1.wav','NULL',120),\n(36,'Chapter04_Lesson02','ch4_l2.wav','NULL',120),\n(37,'Chapter04_Lesson03','ch4_l3.wav','NULL',120),\n(38,'Chapter04_Lesson04','ch4_l4.wav','NULL',120),\n(39,'Chapter04_Question01','ch4_q1.wav','NULL',120),\n(40,'Chapter04_Question02','ch4_q2.wav','NULL',120),\n(41,'Chapter04_Question03','ch4_q3.wav','NULL',120),\n(42,'Chapter04_Question04','ch4_q4.wav','NULL',120),\n(43,'Chapter05_Lesson01','ch5_l1.wav','NULL',120),\n(44,'Chapter05_Lesson02','ch5_l2.wav','NULL',120),\n(45,'Chapter05_Lesson03','ch5_l3.wav','NULL',120),\n(46,'Chapter05_Lesson04','ch5_l4.wav','NULL',120),\n(47,'Chapter05_Question01','ch5_q1.wav','NULL',120),\n(48,'Chapter05_Question02','ch5_q2.wav','NULL',120),\n(49,'Chapter05_Question03','ch5_q3.wav','NULL',120),\n(50,'Chapter05_Question04','ch5_q4.wav','NULL',120),\n(51,'Chapter06_Lesson01','ch6_l1.wav','NULL',120),\n(52,'Chapter06_Lesson02','ch6_l2.wav','NULL',120),\n(53,'Chapter06_Lesson03','ch6_l3.wav','NULL',120),\n(54,'Chapter06_Lesson04','ch6_l4.wav','NULL',120),\n(55,'Chapter06_Question01','ch6_q1.wav','NULL',120),\n(56,'Chapter06_Question02','ch6_q2.wav','NULL',120),\n(57,'Chapter06_Question03','ch6_q3.wav','NULL',120),\n(58,'Chapter06_Question04','ch6_q4.wav','NULL',120),\n(59,'Chapter07_Lesson01','ch7_l1.wav','NULL',120),\n(60,'Chapter07_Lesson02','ch7_l2.wav','NULL',120),\n(61,'Chapter07_Question01','ch7_q1.wav','NULL',120),\n(62,'Chapter07_Question02','ch7_q2.wav','NULL',120),\n(63,'Chapter07_Question03','ch7_q3.wav','NULL',120),\n(64,'Chapter07_Question04','ch7_q4.wav','NULL',120),\n(65,'Chapter08_Lesson01','ch8_l1.wav','NULL',120),\n(66,'Chapter08_Lesson02','ch8_l2.wav','NULL',120),\n(67,'Chapter08_Lesson03','ch8_l3.wav','NULL',120),\n(68,'Chapter08_Lesson04','ch8_l4.wav','NULL',120),\n(69,'Chapter08_Question01','ch8_q1.wav','NULL',120),\n(70,'Chapter08_Question02','ch8_q2.wav','NULL',120),\n(71,'Chapter08_Question03','ch8_q3.wav','NULL',120),\n(72,'Chapter08_Question04','ch8_q4.wav','NULL',120),\n(73,'Chapter09_Lesson01','ch9_l1.wav','NULL',120),\n(74,'Chapter09_Lesson02','ch9_l2.wav','NULL',120),\n(75,'Chapter09_Lesson03','ch9_l3.wav','NULL',120),\n(76,'Chapter09_Lesson04','ch9_l4.wav','NULL',120),\n(77,'Chapter09_Question01','ch9_q1.wav','NULL',120),\n(78,'Chapter09_Question02','ch9_q2.wav','NULL',120),\n(79,'Chapter10_Question03','ch10_q3.wav','NULL',120),\n(80,'Chapter10_Question04','ch10_q4.wav','NULL',120),\n(81,'Chapter11_Lesson01','ch11_l1.wav','NULL',120),\n(82,'Chapter11_Lesson02','ch11_l2.wav','NULL',120),\n(83,'Chapter11_Lesson03','ch11_l3.wav','NULL',120),\n(84,'Chapter11_Lesson04','ch11_l4.wav','NULL',120),\n(85,'Chapter11_Question01','ch11_q1.wav','NULL',120),\n(86,'Chapter11_Question02','ch11_q2.wav','NULL',120),\n(87,'Chapter11_Question03','ch11_q3.wav','NULL',120),\n(88,'Chapter11_Question04','ch11_q4.wav','NULL',120)\nON DUPLICATE KEY UPDATE    \ncontent_name=VALUES(content_name), \nfile_name=VALUES(file_name),\nduration=VALUES(duration);\n";
	...
	public static void main(String[] args) {
		final MA_Dimension MA_DimensionClass = new MA_Dimension();

		int exitCode = MA_DimensionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MA_Dimension.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/ma_dimension_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MA_Dimension");
		}
...
/************************************************************************************************
 * 44496 characters generated by Talend Open Studio for Big Data on the 18 July,
 * 2016 4:07:53 PM IST
 ************************************************************************************************/
