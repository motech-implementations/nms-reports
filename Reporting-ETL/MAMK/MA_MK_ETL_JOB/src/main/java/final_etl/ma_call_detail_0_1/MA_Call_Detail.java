...
package final_etl.ma_call_detail_0_1;
...
/**
 * Job: MA_Call_Detail Purpose: MA_Call_Detail<br>
 * Description: MA_Call_Detail job insert MA cdr data. <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class MA_Call_Detail implements TalendJob {
	...
	private final String jobName = "MA_Call_Detail";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MA_Call_Detail.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MA_Call_Detail.this, new Object[] { e,
	...
	public static class row5Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_MA_Call_Detail.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_MA_Call_Detail.length == 0) {
						commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_MA_Call_Detail, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_MA_Call_Detail, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_MA_Call_Detail) {
	...
	public void tMysqlInput_5Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tMysqlInput_5 = context.report_login;

				final String decryptedPassword_tMysqlInput_5 = context.report_password;
					...
					while (rs_tMysqlInput_5.next()) {
						...
						if (colQtyInRs_tMysqlInput_5 < 1) {
							...
							row6.lastEtlTime = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_5, 1, false);
						}
	...
	public static class insert_ma_flw_cdrStruct implements
			routines.system.IPersistableRow<insert_ma_flw_cdrStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[0];
	...
	public static class row1Struct implements
		...
		public String toString() {
			...
			sb.append(",duration=" + String.valueOf(duration));
			sb.append(",callDurationInPulses="
					+ String.valueOf(callDurationInPulses));
			sb.append(",callId=" + String.valueOf(callId));
			sb.append(",modificationDate=" + modificationDate);
			sb.append("]");
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `"
						...
						+ "` (`id`,`flw_id`,`calling_msisdn`,`operator_id`,`circle_name`,`start_time`,`end_time`,`duration`,`duration_in_pulse`,`call_id`,`modificationDate`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
				...
				String dbquery_tMysqlInput_1 = "SELECT cdr.id,cdr.frontLineWorker_id_OID as 'flw_id',cdr.callingNumber,\ncdr.operator,cdr.circle,cdr.callStartTime,cdr.callEndTime,\nTIMESTAMPDIFF(SECOND,cdr.callStartTime, cdr.callEndTime) as 'duration',\ncdr.callDurationInPulses,cdr.callId,\ncdr.modificationDate\nFROM nms_flw_cdrs cdr\nWHERE cdr.service='MOBILE_ACADEMY' \nAND cdr.creationDate>'"
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 3) {
							row1.callingNumber = 0;
						} else {

							if (rs_tMysqlInput_1.getObject(3) != null) {
								row1.callingNumber = rs_tMysqlInput_1
										.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tMysqlInput_1 < 5) {
							...
							row1.circle = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tMysqlInput_1 < 6) {
							...
							if (rs_tMysqlInput_1.getString(6) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.callStartTime = rs_tMysqlInput_1
											.getTimestamp(6);
								} else {
									row1.callStartTime = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.callStartTime = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 7) {
							...
							if (rs_tMysqlInput_1.getString(7) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.callEndTime = rs_tMysqlInput_1
											.getTimestamp(7);
								} else {
									row1.callEndTime = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.callEndTime = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 9) {
							...
							if (rs_tMysqlInput_1.getObject(9) != null) {
								row1.callDurationInPulses = rs_tMysqlInput_1
										.getInt(9);
							} else {
								row1.callDurationInPulses = null;
							}
						...
						if (colQtyInRs_tMysqlInput_1 < 10) {
							...
							if (rs_tMysqlInput_1.getObject(10) != null) {
								row1.callId = rs_tMysqlInput_1.getLong(10);
							} else {
								row1.callId = null;
							}
						}
						if (colQtyInRs_tMysqlInput_1 < 11) {
							...
							row1.modificationDate = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_1, 11, false);
						}
						...
						{ // start of Var scope
							...
							insert_ma_flw_cdr_tmp.operator_id = ReportingHelper
									.getOperator(
											row1.operator,
											(java.sql.Connection) resourceMap
													.get("conn_tMysqlOutput_1"),
											globalMap);
							insert_ma_flw_cdr_tmp.circle_name = row1.circle;
						...
						if (insert_ma_flw_cdr != null) {
							...
							if (insert_ma_flw_cdr.flw_id == null) {
								...
								pstmt_tMysqlOutput_1.setLong(2,
										insert_ma_flw_cdr.flw_id);
							}

							pstmt_tMysqlOutput_1.setLong(3,
									insert_ma_flw_cdr.calling_msisdn);
							...
							if (insert_ma_flw_cdr.operator_id == null) {
								...
								pstmt_tMysqlOutput_1.setLong(4,
										insert_ma_flw_cdr.operator_id);
							}

							if (insert_ma_flw_cdr.circle_name == null) {
								pstmt_tMysqlOutput_1.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(5,
										insert_ma_flw_cdr.circle_name);
							}

							if (insert_ma_flw_cdr.start_time != null) {
								date_tMysqlOutput_1 = insert_ma_flw_cdr.start_time
										.getTime();
							...
							if (insert_ma_flw_cdr.end_time != null) {
								date_tMysqlOutput_1 = insert_ma_flw_cdr.end_time
										.getTime();
								if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
										|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
							...
							if (insert_ma_flw_cdr.duration_in_pulse == null) {
								...
								pstmt_tMysqlOutput_1.setInt(9,
										insert_ma_flw_cdr.duration_in_pulse);
							}
							...
							if (insert_ma_flw_cdr.modificationDate == null) {
								...
								pstmt_tMysqlOutput_1.setString(11,
										insert_ma_flw_cdr.modificationDate);
							}
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from ma_call_detail_measure),\nETL_info_table.record_count=(SELECT COUNT(*) from ma_call_detail_measure)\nWHERE ETL_info_table.table_id = 19";
	...
	public void tMysqlInput_6Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tMysqlInput_6 = context.report_login;

				final String decryptedPassword_tMysqlInput_6 = context.report_password;

				String dbPwd_tMysqlInput_6 = decryptedPassword_tMysqlInput_6;

				String url_tMysqlInput_6 = "jdbc:mysql://"
						+ context.report_server + ":" + context.report_port
						+ "/" + context.report_database + "?"
						+ context.report_AdditionalParams;
				...
				try {
					...
					while (rs_tMysqlInput_6.next()) {
						...
						if (colQtyInRs_tMysqlInput_6 < 1) {
							row7.lastEtlTime = null;
						} else {

							row7.lastEtlTime = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_6, 1, false);
						}
						...
						globalMap.put("lastEtlTime",
								row7.lastEtlTime != null ? row7.lastEtlTime
										: "");
						nb_line_tJavaRow_2++;
	...
	public static class insert_ma_call_contentStruct implements
			routines.system.IPersistableRow<insert_ma_call_contentStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public String toString() {
			...
			sb.append(",correct_answer_entered="
					+ String.valueOf(correct_answer_entered));
			sb.append(",duration=" + String.valueOf(duration));
			sb.append(",start_time=" + String.valueOf(start_time));
			sb.append(",end_time=" + String.valueOf(end_time));
			sb.append(",type=" + type);
	...
	public static class row2Struct implements
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("id=" + String.valueOf(id));
			sb.append(",callDetailRecord_id_OID="
					+ String.valueOf(callDetailRecord_id_OID));
			sb.append(",completionFlag=" + String.valueOf(completionFlag));
			sb.append(",correctAnswerEntered="
					+ String.valueOf(correctAnswerEntered));
			sb.append(",duration=" + String.valueOf(duration));
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String tableName_tMysqlOutput_2 = "ma_call_content_measure";
				...
				String dbquery_tMysqlInput_2 = "SELECT cc.id,cc.callDetailRecord_id_OID,cc.completionFlag,cc.correctAnswerEntered, \nTIMESTAMPDIFF(SECOND,cc.startTime, cc.endTime) as 'duration',\ncc.startTime,cc.contentName,cc.contentFile,cc.type,cc.endTime,\ncdr.frontLineWorker_id_OID as 'flw_id',\ncc.modificationDate\nFROM nms_call_content cc\nLEFT OUTER JOIN nms_flw_cdrs cdr on cc.callDetailRecord_id_OID=cdr.id\nWHERE cc.mobileKunjiCardCode IS NULL\nAND cc.creationDate>'"
						+ (String) globalMap.get("lastEtlTime")
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (colQtyInRs_tMysqlInput_2 < 2) {
							...
							if (rs_tMysqlInput_2.getObject(2) != null) {
								row2.callDetailRecord_id_OID = rs_tMysqlInput_2
										.getLong(2);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						if (colQtyInRs_tMysqlInput_2 < 3) {
							...
							if (rs_tMysqlInput_2.getObject(3) != null) {
								row2.completionFlag = rs_tMysqlInput_2
										.getBoolean(3);
							} else {
								row2.completionFlag = null;
							}
						...
						if (colQtyInRs_tMysqlInput_2 < 4) {
							...
							if (rs_tMysqlInput_2.getObject(4) != null) {
								row2.correctAnswerEntered = rs_tMysqlInput_2
										.getBoolean(4);
							} else {
								row2.correctAnswerEntered = null;
							}
						...
						if (colQtyInRs_tMysqlInput_2 < 6) {
							...
							if (rs_tMysqlInput_2.getString(6) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_2)) {
									row2.startTime = rs_tMysqlInput_2
											.getTimestamp(6);
								} else {
									row2.startTime = (java.util.Date) year0_tMysqlInput_2
											.clone();
								}
							} else {
								row2.startTime = null;
						...
						if (colQtyInRs_tMysqlInput_2 < 7) {
							...
							row2.contentName = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_2, 7, false);
						}
						if (colQtyInRs_tMysqlInput_2 < 8) {
							row2.contentFile = null;
						} else {

							row2.contentFile = routines.system.JDBCUtil
						...
						if (colQtyInRs_tMysqlInput_2 < 9) {
							...
							row2.type = routines.system.JDBCUtil.getString(
									rs_tMysqlInput_2, 9, false);
						}
						if (colQtyInRs_tMysqlInput_2 < 10) {
							...
							if (rs_tMysqlInput_2.getString(10) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_2)) {
									row2.endTime = rs_tMysqlInput_2
											.getTimestamp(10);
								} else {
									row2.endTime = (java.util.Date) year0_tMysqlInput_2
											.clone();
								}
							} else {
								row2.endTime = null;
						...
						{ // start of Var scope
							...
							Var.contentMap = ReportingHelper.getMAContent(
									row2.contentName, row2.contentFile,
									row2.type,
									(java.sql.Connection) resourceMap
											.get("conn_tMysqlOutput_2"),
									row2.duration);
							Var.var1 = ReportingHelper.setCourseStatus(
									row2.flw_id, row2.contentName,
									row2.startTime, row2.endTime,
									row2.correctAnswerEntered,
									row2.contentFile,
									(java.sql.Connection) resourceMap
											.get("conn_tMysqlOutput_2"));// ###############################
							// ###############################
						...
						if (insert_ma_call_content != null) {
							...
							pstmt_tMysqlOutput_2.setLong(2,
									insert_ma_call_content.call_detail_id);
							...
							if (insert_ma_call_content.percentage_listened == null) {
								...
								pstmt_tMysqlOutput_2
										.setInt(3,
												insert_ma_call_content.percentage_listened);
							}
							...
							if (insert_ma_call_content.content_id == null) {
								...
								pstmt_tMysqlOutput_2.setLong(4,
										insert_ma_call_content.content_id);
							}
							...
							if (insert_ma_call_content.completion_flag == null) {
								...
								pstmt_tMysqlOutput_2.setBoolean(5,
										insert_ma_call_content.completion_flag);
							}
							...
							if (insert_ma_call_content.duration == null) {
								...
								pstmt_tMysqlOutput_2.setInt(7,
										insert_ma_call_content.duration);
							}

							if (insert_ma_call_content.start_time != null) {
								date_tMysqlOutput_2 = insert_ma_call_content.start_time
										.getTime();
							...
							if (insert_ma_call_content.end_time != null) {
								date_tMysqlOutput_2 = insert_ma_call_content.end_time
										.getTime();
								if (date_tMysqlOutput_2 < year1_tMysqlOutput_2
										|| date_tMysqlOutput_2 >= year10000_tMysqlOutput_2) {
							...
							if (insert_ma_call_content.modificationDate == null) {
								...
								pstmt_tMysqlOutput_2
										.setString(
												11,
												insert_ma_call_content.modificationDate);
							}
	...
	public void tMysqlRow_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String driverClass_tMysqlRow_3 = "org.gjt.mm.mysql.Driver";
				java.lang.Class.forName(driverClass_tMysqlRow_3);

				String url_tMysqlRow_3 = "jdbc:mysql://"
						+ context.report_server + ":" + context.report_port
						+ "/" + context.report_database + "?"
						+ context.report_AdditionalParams;
				String dbUser_tMysqlRow_3 = context.report_login;

				final String decryptedPassword_tMysqlRow_3 = context.report_password;

				String dbPwd_tMysqlRow_3 = decryptedPassword_tMysqlRow_3;

				conn_tMysqlRow_3 = java.sql.DriverManager.getConnection(
						url_tMysqlRow_3, dbUser_tMysqlRow_3, dbPwd_tMysqlRow_3);
				...
				query_tMysqlRow_3 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from ma_call_content_measure),\nETL_info_table.record_count=(SELECT COUNT(*) from ma_call_content_measure)\nWHERE ETL_info_table.table_id = 24";
	...
	public static class update_chapter_scoreStruct implements
			routines.system.IPersistableRow<update_chapter_scoreStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String tableName_tMysqlOutput_3 = "ma_call_content_measure";
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 2) {
							...
							row3.startTime = routines.system.JDBCUtil
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							...
							row3.chapterName = routines.system.JDBCUtil
						...
						if (colQtyInRs_tMysqlInput_3 < 4) {
							...
							row3.contentFile = routines.system.JDBCUtil
						...
						{ // start of Var scope
							...
							update_chapter_score_tmp.score = ReportingHelper
									.calculateChapterScore(row3.id,
											row3.startTime, row3.chapterName,
											row3.flw_id, row3.contentFile,
											(java.sql.Connection) resourceMap
													.get("conn_tMysqlOutput_3"));
						...
						if (update_chapter_score != null) {
							...
							if (update_chapter_score.score == null) {
								...
								pstmt_tMysqlOutput_3.setInt(1,
										update_chapter_score.score);
							}

							pstmt_tMysqlOutput_3.setLong(
									2 + count_tMysqlOutput_3,
									update_chapter_score.id);
	...
	public void tMysqlInput_7Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tMysqlInput_7 = context.report_login;

				final String decryptedPassword_tMysqlInput_7 = context.report_password;
				...
				try {
					...
					while (rs_tMysqlInput_7.next()) {
						...
						if (colQtyInRs_tMysqlInput_7 < 1) {
							row8.lastEtlTime = null;
						} else {

							row8.lastEtlTime = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_7, 1, false);
						}
						...
						globalMap.put("lastEtlTime",
								row8.lastEtlTime != null ? row8.lastEtlTime
										: "");
						nb_line_tJavaRow_3++;
	...
	public static class update_course_complete_timeStruct implements
			routines.system.IPersistableRow<update_course_complete_timeStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MA_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MA_Call_Detail = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
	...
	public void tMysqlInput_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String tableName_tMysqlOutput_4 = "ma_call_detail_measure";
				...
				String dbUser_tMysqlInput_4 = context.motech_login;

				final String decryptedPassword_tMysqlInput_4 = context.motech_password;
				...
				String dbquery_tMysqlInput_4 = "SELECT * FROM(SELECT ar.id, ar.creationDate ,ar.creationDate as 'complete_time',flw.id as 'flw_id'\nFROM MTRAINING_MODULE_ACTIVITYRECORD ar\nINNER JOIN nms_front_line_workers flw ON flw.contactNumber=ar.externalId\nWHERE ar.state='COMPLETED'\nAND ar.creationDate>'"
						+ (String) globalMap.get("lastEtlTime")
						+ "'\nORDER BY ar.creationDate ASC) main \nCROSS JOIN (SELECT MAX(modificationDate) AS modificationDate FROM MTRAINING_MODULE_ACTIVITYRECORD\nWHERE state='COMPLETED') act";
				...
				try {
					...
					while (rs_tMysqlInput_4.next()) {
						...
						if (colQtyInRs_tMysqlInput_4 < 2) {
							...
							row4.creationDate = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_4, 2, false);
						}
						if (colQtyInRs_tMysqlInput_4 < 3) {
							...
							if (rs_tMysqlInput_4.getString(3) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_4)) {
									row4.complete_time = rs_tMysqlInput_4
											.getTimestamp(3);
								} else {
									row4.complete_time = (java.util.Date) year0_tMysqlInput_4
											.clone();
								}
							} else {
								row4.complete_time = null;
						...
						if (colQtyInRs_tMysqlInput_4 < 5) {
							...
							if (rs_tMysqlInput_4.getString(5) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_4)) {
									row4.modificationDate = rs_tMysqlInput_4
											.getTimestamp(5);
								} else {
									row4.modificationDate = (java.util.Date) year0_tMysqlInput_4
											.clone();
								}
							} else {
								row4.modificationDate = null;
						...
						{ // start of Var scope
							...
							Var.var1 = ReportingHelper.updateCourseTime(
									row4.flw_id, row4.creationDate,
									row4.complete_time, row4.modificationDate,
									(java.sql.Connection) resourceMap
											.get("conn_tMysqlOutput_4"));// ###############################
							// ###############################
							// # Output tables
							...
							update_course_complete_time_tmp.circle_name = "Dummy";
						...
						if (update_course_complete_time != null) {
							...
							pstmt_tMysqlOutput_4.setLong(1,
							...
							if (checkCount_tMysqlOutput_4 > 0) {
								pstmtUpdate_tMysqlOutput_4
										.setLong(
												1,
												update_course_complete_time.calling_msisdn);

								pstmtUpdate_tMysqlOutput_4.setLong(2,
										update_course_complete_time.call_id);

								if (update_course_complete_time.circle_name == null) {
									...
									pstmtUpdate_tMysqlOutput_4
											.setString(
													3,
													update_course_complete_time.circle_name);
								}

								pstmtUpdate_tMysqlOutput_4.setLong(
										4 + count_tMysqlOutput_4,
										update_course_complete_time.id);
								...
								pstmtInsert_tMysqlOutput_4.setLong(1,
										update_course_complete_time.id);
								...
								pstmtInsert_tMysqlOutput_4.setLong(3,
										update_course_complete_time.call_id);
	...
	public void tMysqlRow_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String driverClass_tMysqlRow_2 = "org.gjt.mm.mysql.Driver";
				java.lang.Class.forName(driverClass_tMysqlRow_2);

				String url_tMysqlRow_2 = "jdbc:mysql://"
						+ context.report_server + ":" + context.report_port
						+ "/" + context.report_database + "?"
						+ context.report_AdditionalParams;
				String dbUser_tMysqlRow_2 = context.report_login;

				final String decryptedPassword_tMysqlRow_2 = context.report_password;

				String dbPwd_tMysqlRow_2 = decryptedPassword_tMysqlRow_2;

				conn_tMysqlRow_2 = java.sql.DriverManager.getConnection(
						url_tMysqlRow_2, dbUser_tMysqlRow_2, dbPwd_tMysqlRow_2);

				if (conn_tMysqlRow_2.getAutoCommit()) {

					conn_tMysqlRow_2.setAutoCommit(false);

				}
				int commitEvery_tMysqlRow_2 = 10000;
				int commitCounter_tMysqlRow_2 = 0;
				...
				query_tMysqlRow_2 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT MAX(activityModificationDate)FROM ma_course_status),\nETL_info_table.record_count=1\nWHERE ETL_info_table.table_id = 17";
				...
				commitCounter_tMysqlRow_2++;
				if (commitEvery_tMysqlRow_2 <= commitCounter_tMysqlRow_2) {

					conn_tMysqlRow_2.commit();

					commitCounter_tMysqlRow_2 = 0;
				}
	...
	public static void main(String[] args) {
		final MA_Call_Detail MA_Call_DetailClass = new MA_Call_Detail();

		int exitCode = MA_Call_DetailClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MA_Call_Detail.class
					.getClassLoader().getResourceAsStream(
							"final_etl/ma_call_detail_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MA_Call_Detail");
		}
...
/************************************************************************************************
 * 214523 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:34 PM PDT
 ************************************************************************************************/
