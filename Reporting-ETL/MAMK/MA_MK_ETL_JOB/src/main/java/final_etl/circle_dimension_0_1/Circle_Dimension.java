...
package final_etl.circle_dimension_0_1;
...
/**
 * Job: Circle_Dimension Purpose: Circle_Dimension<br>
 * Description: Circle_Dimension <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Circle_Dimension implements TalendJob {
	...
	private final String jobName = "Circle_Dimension";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Circle_Dimension.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Circle_Dimension.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Circle_Dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Circle_Dimension = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Circle_Dimension.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Circle_Dimension.length == 0) {
						commonByteArray_FINAL_ETL_Circle_Dimension = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Circle_Dimension = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Circle_Dimension, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_Circle_Dimension, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Circle_Dimension) {
	...
	public static class update_circle_dimensionStruct implements
			routines.system.IPersistableRow<update_circle_dimensionStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_Circle_Dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Circle_Dimension = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final update_circle_dimensionStruct other = (update_circle_dimensionStruct) obj;
		...
		public void copyDataTo(update_circle_dimensionStruct other) {
		...
		public void copyKeysDataTo(update_circle_dimensionStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(update_circle_dimensionStruct other) {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				update_circle_dimensionStruct update_circle_dimension = new update_circle_dimensionStruct();
				...
				String tableName_tMysqlOutput_1 = "circle_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "circle_dimension" + "` WHERE `id` = ?");
				String insert_tMysqlOutput_1 = "INSERT INTO `"
						+ "circle_dimension"
						+ "` (`id`,`circle_name`,`modificationDate`) VALUES (?,?,?)";
				...
				String update_tMysqlOutput_1 = "UPDATE `"
						+ "circle_dimension"
						+ "` SET `circle_name` = ?,`modificationDate` = ? WHERE `id` = ?";
				...
				update_circle_dimensionStruct update_circle_dimension_tmp = new update_circle_dimensionStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_1 = "SELECT c.id,c.name,c.modificationDate\nFROM nms_circles c\nWHERE c.creationDate>'"
						+ (String) globalMap.get("lastEtlTime")
						+ "'\nOR c.modificationDate >'"
						+ (String) globalMap.get("lastEtlTime") + "'";
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						{ // start of Var scope
							...
							update_circle_dimension = null;

							// # Output table : 'update_circle_dimension'
							update_circle_dimension_tmp.id = row1.id;
							update_circle_dimension_tmp.circle_name = row1.name;
							update_circle_dimension_tmp.modificationDate = row1.modificationDate;
							update_circle_dimension = update_circle_dimension_tmp;
							// ###############################
						 ...
						 * [tMap_1 main ] stop
						 */
						// Start of branch "update_circle_dimension"
						if (update_circle_dimension != null) {
							...
							if (checkCount_tMysqlOutput_1 > 0) {
								if (update_circle_dimension.circle_name == null) {
									...
									pstmtUpdate_tMysqlOutput_1
											.setString(
													1,
													update_circle_dimension.circle_name);
								}

								if (update_circle_dimension.modificationDate == null) {
									...
									pstmtUpdate_tMysqlOutput_1
											.setString(
													2,
													update_circle_dimension.modificationDate);
								}

								pstmtUpdate_tMysqlOutput_1.setLong(
										3 + count_tMysqlOutput_1,
										update_circle_dimension.id);
						...
						} // End of branch "update_circle_dimension"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from circle_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from circle_dimension)\nWHERE ETL_info_table.table_id = 15";
	...
	public static void main(String[] args) {
		final Circle_Dimension Circle_DimensionClass = new Circle_Dimension();

		int exitCode = Circle_DimensionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Circle_Dimension.class
					.getClassLoader().getResourceAsStream(
							"final_etl/circle_dimension_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Circle_Dimension");
		}
...
/************************************************************************************************
 * 80300 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:34 PM PDT
 ************************************************************************************************/
