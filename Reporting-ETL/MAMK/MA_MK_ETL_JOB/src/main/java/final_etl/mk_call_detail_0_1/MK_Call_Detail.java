...
package final_etl.mk_call_detail_0_1;
...
/**
 * Job: MK_Call_Detail Purpose: MK_Call_Detail<br>
 * Description: MK_Call_Detail <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class MK_Call_Detail implements TalendJob {
	...
	private final String jobName = "MK_Call_Detail";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					MK_Call_Detail.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(MK_Call_Detail.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_MK_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MK_Call_Detail = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_MK_Call_Detail.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_MK_Call_Detail.length == 0) {
						commonByteArray_FINAL_ETL_MK_Call_Detail = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_MK_Call_Detail = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_MK_Call_Detail, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_MK_Call_Detail, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_MK_Call_Detail) {
	...
	public static class insert_mk_flw_cdrStruct implements
			routines.system.IPersistableRow<insert_mk_flw_cdrStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MK_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MK_Call_Detail = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final insert_mk_flw_cdrStruct other = (insert_mk_flw_cdrStruct) obj;
		...
		public void copyDataTo(insert_mk_flw_cdrStruct other) {
		...
		public void copyKeysDataTo(insert_mk_flw_cdrStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(insert_mk_flw_cdrStruct other) {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				insert_mk_flw_cdrStruct insert_mk_flw_cdr = new insert_mk_flw_cdrStruct();
				...
				String tableName_tMysqlOutput_1 = "mk_call_detail_measure";
				...
				insert_mk_flw_cdrStruct insert_mk_flw_cdr_tmp = new insert_mk_flw_cdrStruct();
				// ###############################
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						{ // start of Var scope
							...
							insert_mk_flw_cdr = null;

							// # Output table : 'insert_mk_flw_cdr'
							insert_mk_flw_cdr_tmp.id = row1.id;
							insert_mk_flw_cdr_tmp.flw_id = row1.flw_id;
							insert_mk_flw_cdr_tmp.calling_msisdn = row1.callingNumber;
							insert_mk_flw_cdr_tmp.operator_id = ReportingHelper
									.getOperator(
											row1.operator,
											(java.sql.Connection) resourceMap
													.get("conn_tMysqlOutput_1"),
											globalMap);
							insert_mk_flw_cdr_tmp.circle_name = row1.circle;
							insert_mk_flw_cdr_tmp.start_time = row1.callStartTime;
							insert_mk_flw_cdr_tmp.end_time = row1.callEndTime;
							insert_mk_flw_cdr_tmp.duration = row1.duration;
							insert_mk_flw_cdr_tmp.duration_in_pulse = row1.callDurationInPulses;
							insert_mk_flw_cdr_tmp.call_id = row1.callId;
							insert_mk_flw_cdr_tmp.modificationDate = row1.modificationDate;
							insert_mk_flw_cdr = insert_mk_flw_cdr_tmp;
							// ###############################
						 ...
						 * [tMap_1 main ] stop
						 */
						// Start of branch "insert_mk_flw_cdr"
						if (insert_mk_flw_cdr != null) {
							...
							pstmt_tMysqlOutput_1.setLong(1,
									insert_mk_flw_cdr.id);

							if (insert_mk_flw_cdr.flw_id == null) {
								pstmt_tMysqlOutput_1.setNull(2,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1.setLong(2,
										insert_mk_flw_cdr.flw_id);
							}

							pstmt_tMysqlOutput_1.setLong(3,
									insert_mk_flw_cdr.calling_msisdn);

							if (insert_mk_flw_cdr.operator_id == null) {
								pstmt_tMysqlOutput_1.setNull(4,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1.setLong(4,
										insert_mk_flw_cdr.operator_id);
							}

							if (insert_mk_flw_cdr.circle_name == null) {
								pstmt_tMysqlOutput_1.setNull(5,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(5,
										insert_mk_flw_cdr.circle_name);
							}

							if (insert_mk_flw_cdr.start_time != null) {
								date_tMysqlOutput_1 = insert_mk_flw_cdr.start_time
										.getTime();
							...
							if (insert_mk_flw_cdr.end_time != null) {
								date_tMysqlOutput_1 = insert_mk_flw_cdr.end_time
										.getTime();
								if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
										|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
							...
							if (insert_mk_flw_cdr.duration == null) {
								pstmt_tMysqlOutput_1.setNull(8,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1.setInt(8,
										insert_mk_flw_cdr.duration);
							}

							if (insert_mk_flw_cdr.duration_in_pulse == null) {
								pstmt_tMysqlOutput_1.setNull(9,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1.setInt(9,
										insert_mk_flw_cdr.duration_in_pulse);
							}

							if (insert_mk_flw_cdr.call_id == null) {
								pstmt_tMysqlOutput_1.setNull(10,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_1.setLong(10,
										insert_mk_flw_cdr.call_id);
							}

							if (insert_mk_flw_cdr.modificationDate == null) {
								pstmt_tMysqlOutput_1.setNull(11,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(11,
										insert_mk_flw_cdr.modificationDate);
							}
						...
						} // End of branch "insert_mk_flw_cdr"
	...
	public void tMysqlRow_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_2 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from mk_call_detail_measure),\nETL_info_table.record_count=(SELECT COUNT(*) from mk_call_detail_measure)\nWHERE ETL_info_table.table_id = 22";
	...
	public void tMysqlInput_4Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				String dbUser_tMysqlInput_4 = context.report_login;

				final String decryptedPassword_tMysqlInput_4 = context.report_password;
				...
				String dbquery_tMysqlInput_4 = "SELECT last_etl_time FROM ETL_info_table\nWHERE table_id=23";
				...
				try {
					...
					while (rs_tMysqlInput_4.next()) {
						...
						if (colQtyInRs_tMysqlInput_4 < 1) {
							row5.lastEtlTime = null;
						} else {

							row5.lastEtlTime = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_4, 1, false);
						}
						...
						globalMap.put("lastEtlTime",
								row5.lastEtlTime != null ? row5.lastEtlTime
										: "");
						nb_line_tJavaRow_2++;
	...
	public static class insert_mk_call_contentStruct implements
			routines.system.IPersistableRow<insert_mk_call_contentStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_MK_Call_Detail = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_MK_Call_Detail = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final insert_mk_call_contentStruct other = (insert_mk_call_contentStruct) obj;
		...
		public void copyDataTo(insert_mk_call_contentStruct other) {
			...
			other.start_time = this.start_time;
			other.end_time = this.end_time;
			other.content_name = this.content_name;
			other.modificationDate = this.modificationDate;

		}

		public void copyKeysDataTo(insert_mk_call_contentStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_MK_Call_Detail) {
				...
				try {
					...
					this.content_name = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.content_name, dos);
		...
		public String toString() {
			...
			sb.append(",start_time=" + String.valueOf(start_time));
			sb.append(",end_time=" + String.valueOf(end_time));
			sb.append(",content_name=" + content_name);
			sb.append(",modificationDate=" + modificationDate);
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(insert_mk_call_contentStruct other) {
	...
	public static class row2Struct implements
		...
		public String mobileKunjiCardCode;

		public String getMobileKunjiCardCode() {
			return this.mobileKunjiCardCode;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_MK_Call_Detail) {
				...
				try {
					...
					length = dis.readByte();
					if (length == -1) {
						this.callDetailRecord_id_OID = null;
					} else {
						this.callDetailRecord_id_OID = dis.readLong();
					}

					this.mobileKunjiCardCode = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.callDetailRecord_id_OID == null) {
					dos.writeByte(-1);
				} else {
					dos.writeByte(0);
				...
				writeString(this.mobileKunjiCardCode, dos);
		...
		public String toString() {
			...
			sb.append(",mobileKunjiCardCode=" + mobileKunjiCardCode);
			sb.append(",duration=" + String.valueOf(duration));
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				insert_mk_call_contentStruct insert_mk_call_content = new insert_mk_call_contentStruct();
				...
				String tableName_tMysqlOutput_2 = "mk_call_content_measure";
				...
				String insert_tMysqlOutput_2 = "INSERT INTO `"
						+ "mk_call_content_measure"
						+ "` (`id`,`call_detail_id`,`percentage_listened`,`content_id`,`duration`,`start_time`,`end_time`,`content_name`,`modificationDate`) VALUES (?,?,?,?,?,?,?,?,?)";
				...
				// ###############################
				// # Outputs initialization
				insert_mk_call_contentStruct insert_mk_call_content_tmp = new insert_mk_call_contentStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_2 = "SELECT id,cc.callDetailRecord_id_OID,mobileKunjiCardCode, \nTIMESTAMPDIFF(SECOND,cc.startTime, cc.endTime) as 'duration',\ncc.startTime,cc.contentName,cc.contentFile,cc.endTime,\ncc.modificationDate\nFROM nms_call_content cc\nWHERE cc.mobileKunjiCardCode IS NOT NULL\nAND cc.creationDate>'"
						+ (String) globalMap.get("lastEtlTime")
				...
				try {
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (colQtyInRs_tMysqlInput_2 < 2) {
							row2.callDetailRecord_id_OID = null;
						} else {
						...
						if (colQtyInRs_tMysqlInput_2 < 3) {
							row2.mobileKunjiCardCode = null;
						} else {

							row2.mobileKunjiCardCode = routines.system.JDBCUtil
						...
						if (colQtyInRs_tMysqlInput_2 < 4) {
							...
							if (rs_tMysqlInput_2.getObject(4) != null) {
								row2.duration = rs_tMysqlInput_2.getInt(4);
							} else {
								row2.duration = null;
							}
						}
						...
						{ // start of Var scope
							...
							Var.contentMap = ReportingHelper.getMKContent(
									row2.contentName, row2.contentFile,
									row2.mobileKunjiCardCode,
									(java.sql.Connection) resourceMap
							...
							insert_mk_call_content = null;

							// # Output table : 'insert_mk_call_content'
							insert_mk_call_content_tmp.id = row2.id;
							insert_mk_call_content_tmp.call_detail_id = row2.callDetailRecord_id_OID;
							insert_mk_call_content_tmp.percentage_listened = (Integer) ((java.util.Map<String, Object>) Var.contentMap)
									.get("percentageListened");
							insert_mk_call_content_tmp.content_id = (Long) ((java.util.Map<String, Object>) Var.contentMap)
									.get("contentId");
							insert_mk_call_content_tmp.duration = row2.duration;
							insert_mk_call_content_tmp.start_time = row2.startTime;
							insert_mk_call_content_tmp.end_time = row2.endTime;
							insert_mk_call_content_tmp.content_name = row2.contentName;
							insert_mk_call_content_tmp.modificationDate = row2.modificationDate;
							insert_mk_call_content = insert_mk_call_content_tmp;
							// ###############################
						 ...
						 * [tMap_2 main ] stop
						 */
						// Start of branch "insert_mk_call_content"
						if (insert_mk_call_content != null) {
							...
							pstmt_tMysqlOutput_2.setLong(1,
									insert_mk_call_content.id);

							if (insert_mk_call_content.call_detail_id == null) {
								pstmt_tMysqlOutput_2.setNull(2,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_2.setLong(2,
										insert_mk_call_content.call_detail_id);
							}

							if (insert_mk_call_content.percentage_listened == null) {
								pstmt_tMysqlOutput_2.setNull(3,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_2
										.setInt(3,
												insert_mk_call_content.percentage_listened);
							}

							if (insert_mk_call_content.content_id == null) {
								pstmt_tMysqlOutput_2.setNull(4,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_2.setLong(4,
										insert_mk_call_content.content_id);
							}

							if (insert_mk_call_content.duration == null) {
								pstmt_tMysqlOutput_2.setNull(5,
										java.sql.Types.INTEGER);
							} else {
								pstmt_tMysqlOutput_2.setInt(5,
										insert_mk_call_content.duration);
							}

							if (insert_mk_call_content.start_time != null) {
								date_tMysqlOutput_2 = insert_mk_call_content.start_time
										.getTime();
							...
							if (insert_mk_call_content.end_time != null) {
								date_tMysqlOutput_2 = insert_mk_call_content.end_time
										.getTime();
								if (date_tMysqlOutput_2 < year1_tMysqlOutput_2
										|| date_tMysqlOutput_2 >= year10000_tMysqlOutput_2) {
							...
							if (insert_mk_call_content.content_name == null) {
								pstmt_tMysqlOutput_2.setNull(8,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_2.setString(8,
										insert_mk_call_content.content_name);
							}

							if (insert_mk_call_content.modificationDate == null) {
								...
								pstmt_tMysqlOutput_2
										.setString(
												9,
												insert_mk_call_content.modificationDate);
							}
						...
						} // End of branch "insert_mk_call_content"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from mk_call_content_measure),\nETL_info_table.record_count=(SELECT COUNT(*) from mk_call_content_measure)\nWHERE ETL_info_table.table_id = 23";
	...
	public static void main(String[] args) {
		final MK_Call_Detail MK_Call_DetailClass = new MK_Call_Detail();

		int exitCode = MK_Call_DetailClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = MK_Call_Detail.class
					.getClassLoader().getResourceAsStream(
							"final_etl/mk_call_detail_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : MK_Call_Detail");
		}
...
/************************************************************************************************
 * 142365 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:34 PM PDT
 ************************************************************************************************/
