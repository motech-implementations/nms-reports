...
package final_etl.ma_mk_etl_job_0_1;
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.ma_mk_data_0_1.MA_MK_Data childJob_tRunJob_2 = new final_etl.ma_mk_data_0_1.MA_MK_Data();
				// pass DataSources
		...
		try {
			...
			java.io.InputStream inContext = MA_MK_ETL_JOB.class
					.getClassLoader().getResourceAsStream(
							"final_etl/ma_mk_etl_job_0_1/contexts/"
...
/************************************************************************************************
 * 48613 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:34 PM PDT
 ************************************************************************************************/
