...
package final_etl.district_0_1;
...
/**
 * Job: District Purpose: district_dimension reporting table<br>
 * Description: District report table generated by motech_data_services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class District implements TalendJob {
	...
	private final String jobName = "District";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(District.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_District = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_District = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_District.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_District.length == 0) {
						commonByteArray_FINAL_ETL_District = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_District = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_District, 0, length);
				strReturn = new String(commonByteArray_FINAL_ETL_District, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_District) {
	...
	public static class district_data_to_be_updatedStruct implements
			routines.system.IPersistableRow<district_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_District = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_District = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final district_data_to_be_updatedStruct other = (district_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(district_data_to_be_updatedStruct other) {
		...
		public void copyKeysDataTo(district_data_to_be_updatedStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(district_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				district_data_to_be_updatedStruct district_data_to_be_updated = new district_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "district_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "district_dimension" + "` WHERE `Id` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "district_dimension"
						+ "` (`Id`,`district_name`,`state_id`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "district_dimension"
						+ "` SET `district_name` = ?,`state_id` = ?,`modificationDate` = ? WHERE `Id` = ?";
				...
				district_data_to_be_updatedStruct district_data_to_be_updated_tmp = new district_data_to_be_updatedStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_3 = "select id, name,state_id_OID,modificationDate from \nnms_districts\nWHERE creationDate>'"
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							...
							if (rs_tMysqlInput_3.getObject(3) != null) {
								row3.state_id_OID = rs_tMysqlInput_3.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						{ // start of Var scope
							...
							district_data_to_be_updated = null;

							// # Output table : 'district_data_to_be_updated'
							district_data_to_be_updated_tmp.Id = row3.id;
							district_data_to_be_updated_tmp.district_name = row3.name;
							district_data_to_be_updated_tmp.state_id = row3.state_id_OID;
							district_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							district_data_to_be_updated = district_data_to_be_updated_tmp;
							// ###############################
						 ...
						 * [tMap_4 main ] stop
						 */
						// Start of branch "district_data_to_be_updated"
						if (district_data_to_be_updated != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1,
									district_data_to_be_updated.Id);
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (district_data_to_be_updated.district_name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													district_data_to_be_updated.district_name);
								}

								pstmtUpdate_tMysqlOutput_3.setLong(2,
										district_data_to_be_updated.state_id);

								if (district_data_to_be_updated.modificationDate != null) {
									date_tMysqlOutput_3 = district_data_to_be_updated.modificationDate
											.getTime();
						...
						} // End of branch "district_data_to_be_updated"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT MAX(modificationDate) from district_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from district_dimension)\nWHERE ETL_info_table.table_id = 2";
	...
	public static void main(String[] args) {
		final District DistrictClass = new District();

		int exitCode = DistrictClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = District.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/district_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : District");
		}
...
/************************************************************************************************
 * 83477 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:02 PM PDT
 ************************************************************************************************/
