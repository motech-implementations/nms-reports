...
package final_etl.log_etl_table_info_0_1;
...
/**
 * Job: Log_Etl_Table_Info Purpose: Log_Etl_Table_Info<br>
 * Description: Log_Etl_Table_Info <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Log_Etl_Table_Info implements TalendJob {
	...
	private final String jobName = "Log_Etl_Table_Info";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Log_Etl_Table_Info.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Log_Etl_Table_Info.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Log_Etl_Table_Info = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Log_Etl_Table_Info = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Log_Etl_Table_Info.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Log_Etl_Table_Info.length == 0) {
						commonByteArray_FINAL_ETL_Log_Etl_Table_Info = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Log_Etl_Table_Info = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Log_Etl_Table_Info, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_Log_Etl_Table_Info, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Log_Etl_Table_Info) {
	...
	public static class row1Struct implements
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Log_Etl_Table_Info) {
				...
				try {
					...
					if (length == -1) {
						...
						this.recordCount = dis.readLong();
					}

					this.lastEtlTime = readString(dis);

					this.etlJob = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				if (this.recordCount == null) {
					...
					dos.writeByte(0);
					dos.writeLong(this.recordCount);
				}
		...
		public String toString() {
			...
			sb.append(super.toString());
			sb.append("[");
			sb.append("tableId=" + String.valueOf(tableId));
			sb.append(",recordCount=" + String.valueOf(recordCount));
			sb.append(",lastEtlTime=" + lastEtlTime);
			sb.append(",etlJob=" + etlJob);
			sb.append("]");
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				util_tLogRow_1.addRow(new String[] { "tableId", "recordCount",
						"lastEtlTime", "etlJob", });
				...
				String dbquery_tMysqlInput_1 = "SELECT table_id, record_count, last_etl_time ,etl_job \nFROM ETL_info_table";
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 1) {
							...
							if (rs_tMysqlInput_1.getObject(1) != null) {
								row1.tableId = rs_tMysqlInput_1.getInt(1);
							} else {
						...
						if (colQtyInRs_tMysqlInput_1 < 2) {
							row1.recordCount = null;
						} else {

							if (rs_tMysqlInput_1.getObject(2) != null) {
								row1.recordCount = rs_tMysqlInput_1.getLong(2);
							} else {
								row1.recordCount = null;
							}
						}
						if (colQtyInRs_tMysqlInput_1 < 3) {
							row1.lastEtlTime = null;
						} else {

							row1.lastEtlTime = routines.system.JDBCUtil
						...
						if (colQtyInRs_tMysqlInput_1 < 4) {
							...
							row1.etlJob = routines.system.JDBCUtil.getString(
						...
						row_tLogRow_1[0] = String.valueOf(row1.tableId);

						if (row1.recordCount != null) { //
							row_tLogRow_1[1] = String.valueOf(row1.recordCount);

						} //

						if (row1.lastEtlTime != null) { //
							row_tLogRow_1[2] = String.valueOf(row1.lastEtlTime);

						} //

						if (row1.etlJob != null) { //
							row_tLogRow_1[3] = String.valueOf(row1.etlJob);
	...
	public static void main(String[] args) {
		final Log_Etl_Table_Info Log_Etl_Table_InfoClass = new Log_Etl_Table_Info();

		int exitCode = Log_Etl_Table_InfoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Log_Etl_Table_Info.class
					.getClassLoader().getResourceAsStream(
							"final_etl/log_etl_table_info_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Log_Etl_Table_Info");
		}
...
/************************************************************************************************
 * 57705 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:00 PM PDT
 ************************************************************************************************/
