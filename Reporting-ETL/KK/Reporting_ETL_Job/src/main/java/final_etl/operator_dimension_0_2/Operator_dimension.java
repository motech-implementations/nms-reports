...
package final_etl.operator_dimension_0_2;
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "INSERT INTO `operator_dimension` (`operator_code`,`Operator`,`DW_LastUpdatedDtim`) \nVALUES ('D','Aircel',now()),	 \n('A','Airtel',now()),		 \n('B','BSNL',now()),	 \n('L','BPL',now()),\n('C','Datacom Solutions',now()),	 \n('H','HFCL Infotel',now()),\n('I','Idea',now()),	 \n('M','MTNL',now()),	 \n('R','Reliance GSM',now()),	 \n('E','Reliance CDMA',now()),	 \n('S','S. Tel',now()),\n('Y','Shyam Telecom',now()),	 \n('P','Spice',now()),\n('W','Swan Telecom',now()),\n('T','Tata Docomo',now()),	 \n('U','Uninor',now()),	 \n('V','Vodafone',now()),	 \n('9','Unknown',now())\nON DUPLICATE KEY UPDATE    \nOperator=VALUES(Operator), \nDW_LastUpdatedDtim=VALUES(DW_LastUpdatedDtim);\n";
		...
		try {
			...
			java.io.InputStream inContext = Operator_dimension.class
					.getClassLoader().getResourceAsStream(
							"final_etl/operator_dimension_0_2/contexts/"
...
/************************************************************************************************
 * 40490 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:03 PM PDT
 ************************************************************************************************/
