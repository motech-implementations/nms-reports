...
package final_etl.date_dimension_0_1;
...
/**
 * Job: date_dimension Purpose: date_dimension table<br>
 * Description: date_dimension table <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class date_dimension implements TalendJob {
	...
	private final String jobName = "date_dimension";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					date_dimension.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(date_dimension.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_date_dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_date_dimension = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_date_dimension.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_date_dimension.length == 0) {
						commonByteArray_FINAL_ETL_date_dimension = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_date_dimension = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_date_dimension, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_date_dimension, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_date_dimension) {
	...
	public static class generated_datesStruct implements
			routines.system.IPersistableRow<generated_datesStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_date_dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_date_dimension = new byte[0];
		...
		public String DimDay;

		public String getDimDay() {
			return this.DimDay;
		}

		public int DimWeek_NUM;

		public int getDimWeek_NUM() {
			return this.DimWeek_NUM;
		}

		public String DimMonth;

		public String getDimMonth() {
			return this.DimMonth;
		}

		public long DimYear;

		public long getDimYear() {
			return this.DimYear;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_date_dimension) {
				...
				try {
					...
					this.DimDay = readString(dis);

					this.DimWeek_NUM = dis.readInt();

					this.DimMonth = readString(dis);

					this.DimYear = dis.readLong();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.DimDay, dos);

				// int

				dos.writeInt(this.DimWeek_NUM);

				// String

				writeString(this.DimMonth, dos);

				// long

				dos.writeLong(this.DimYear);
		...
		public String toString() {
			...
			sb.append(",DimDay=" + DimDay);
			sb.append(",DimWeek_NUM=" + String.valueOf(DimWeek_NUM));
			sb.append(",DimMonth=" + DimMonth);
			sb.append(",DimYear=" + String.valueOf(DimYear));
			sb.append("]");
		 ...
		 * Compare keys
		 */
		public int compareTo(generated_datesStruct other) {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				generated_datesStruct generated_dates = new generated_datesStruct();
				...
				String tableName_tMysqlOutput_1 = "date_dimension";
				...
				class BufferLine_tMysqlOutput_1 {

					java.util.Date FullDate;
					String DimDay;
					int DimWeek_NUM;
					String DimMonth;
					long DimYear;

					public BufferLine_tMysqlOutput_1(java.util.Date FullDate,
							String DimDay, int DimWeek_NUM, String DimMonth,
							long DimYear) {

						this.FullDate = FullDate;
						this.DimDay = DimDay;
						this.DimWeek_NUM = DimWeek_NUM;
						this.DimMonth = DimMonth;
						this.DimYear = DimYear;
					}
				}

				java.util.List<BufferLine_tMysqlOutput_1> exInsertColValueListtMysqlOutput_1 = new java.util.ArrayList();
				BufferLine_tMysqlOutput_1 exInsertColValuetMysqlOutput_1 = null;

				StringBuilder extendInsertValueStmt_tMysqlOutput_1 = new StringBuilder();
				for (int i = 0; i < 100; i++) {
					extendInsertValueStmt_tMysqlOutput_1.append("(?,?,?,?,?)");
					if (i != 100 - 1)
						extendInsertValueStmt_tMysqlOutput_1.append(",");
				}
				...
				String insert_tMysqlOutput_1 = "INSERT INTO `"
						+ "date_dimension"
						+ "` (`FullDate`,`DimDay`,`DimWeek_NUM`,`DimMonth`,`DimYear`) VALUES "
						+ extendInsertValueStmt_tMysqlOutput_1.toString();

				java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1
						.prepareStatement(insert_tMysqlOutput_1);

				String insertColNametMysqlOutput_1 = "`FullDate`,`DimDay`,`DimWeek_NUM`,`DimMonth`,`DimYear`";
				String insertColValuetMysqlOutput_1 = "?,?,?,?,?";
				int rowCounttMysqlOutput_1 = 0;
				...
				generated_datesStruct generated_dates_tmp = new generated_datesStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_1 = "select a.Date, DAYNAME(a.Date), WEEKOFYEAR(a.Date), MONTHNAME(a.Date), YEAR(a.Date) \n	from \n      (select DATE_FORMAT(date1.fdate,'%Y-%m-%d') + INTERVAL (a.a + (10 * b.a)) DAY as Date\n                          from \n                            (select CASE record_count \n                              WHEN 0 THEN now() - INTERVAL 90 DAY \n							  ELSE DATE_ADD(last_etl_time, INTERVAL 7 DAY) END \n                              as fdate from ETL_info_table WHERE ETL_info_table.table_id=8) as date1,\n		(select 0 as a union all select 1 union all select 2 union all select 3 \n		union all select 4 union all select 5 union all select 6 union all select 7 union all select 8 \n        union all select 9) as a\n        cross join \n		(select 0 as a union all select 1 union all select 2 union all select 3 union all select 4 \n         union all select 5 union all select 6 union all select 7 union all select 8 \n         union all select 9) as b                         \n		) a\n  Where a.date <= now()+ INTERVAL 6 DAY";
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 1) {
							...
							if (rs_tMysqlInput_1.getString(1) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.Date = rs_tMysqlInput_1
											.getTimestamp(1);
								} else {
									row1.Date = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.Date = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 2) {
							...
							row1.DimDay = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tMysqlInput_1 < 3) {
							...
							if (rs_tMysqlInput_1.getObject(3) != null) {
								row1.DimWeek_NUM = rs_tMysqlInput_1.getInt(3);
							} else {
						...
						if (colQtyInRs_tMysqlInput_1 < 4) {
							...
							row1.DimMonth = routines.system.JDBCUtil.getString(
						...
						if (colQtyInRs_tMysqlInput_1 < 5) {
							...
							if (rs_tMysqlInput_1.getObject(5) != null) {
								row1.DimYear = rs_tMysqlInput_1.getLong(5);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						{ // start of Var scope
							...
							generated_dates = null;

							// # Output table : 'generated_dates'
							generated_dates_tmp.FullDate = row1.Date;
							generated_dates_tmp.DimDay = row1.DimDay;
							generated_dates_tmp.DimWeek_NUM = row1.DimWeek_NUM;
							generated_dates_tmp.DimMonth = row1.DimMonth;
							generated_dates_tmp.DimYear = row1.DimYear;
							generated_dates = generated_dates_tmp;
							// ###############################
						 ...
						 * [tMap_1 main ] stop
						 */
						// Start of branch "generated_dates"
						if (generated_dates != null) {
							...
							int countertMysqlOutput_1 = rowCounttMysqlOutput_1 * 5 + 1;

							if (generated_dates.FullDate != null) {
								// timestamp < min java date value (year 1) ||
								// timestamp > max mysql value (year 10000) =>
								// set 0000-00-00 as date in MySQL
								date_tMysqlOutput_1 = generated_dates.FullDate
										.getTime();
								if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
										|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
									pstmt_tMysqlOutput_1.setString(
											countertMysqlOutput_1,
											"0000-00-00 00:00:00");
								} else {
									pstmt_tMysqlOutput_1.setTimestamp(
											countertMysqlOutput_1,
							...
							if (generated_dates.DimDay == null) {
								pstmt_tMysqlOutput_1.setNull(
										countertMysqlOutput_1,
								...
								pstmt_tMysqlOutput_1.setString(
										countertMysqlOutput_1,
										generated_dates.DimDay);

							}

							countertMysqlOutput_1++;

							pstmt_tMysqlOutput_1.setInt(countertMysqlOutput_1,
									generated_dates.DimWeek_NUM);
							countertMysqlOutput_1++;

							if (generated_dates.DimMonth == null) {
								pstmt_tMysqlOutput_1.setNull(
										countertMysqlOutput_1,
										java.sql.Types.VARCHAR);
							} else {
								pstmt_tMysqlOutput_1.setString(
										countertMysqlOutput_1,
										generated_dates.DimMonth);

							}

							countertMysqlOutput_1++;

							pstmt_tMysqlOutput_1.setLong(countertMysqlOutput_1,
									generated_dates.DimYear);
							countertMysqlOutput_1++;

							exInsertColValuetMysqlOutput_1 = new BufferLine_tMysqlOutput_1(
									generated_dates.FullDate,
									generated_dates.DimDay,
									generated_dates.DimWeek_NUM,
									generated_dates.DimMonth,
									generated_dates.DimYear);

							exInsertColValueListtMysqlOutput_1
									.add(exInsertColValuetMysqlOutput_1);

							rowCounttMysqlOutput_1++;
							if (rowCounttMysqlOutput_1 == 100) {
								try {
								...
								exInsertColValueListtMysqlOutput_1.clear();
								rowCounttMysqlOutput_1 = 0;
								countertMysqlOutput_1 = 1;
							}
				...
				if (rowCounttMysqlOutput_1 != 0) {

					StringBuilder extendInsertValueStmt = new StringBuilder();
					for (int i = 0; i < rowCounttMysqlOutput_1; i++) {
						extendInsertValueStmt.append("("
								+ insertColValuetMysqlOutput_1 + ")");
						if (i != rowCounttMysqlOutput_1 - 1)
							extendInsertValueStmt.append(",");
					}

					insert_tMysqlOutput_1 = "INSERT INTO `" + "date_dimension"
							+ "` (" + insertColNametMysqlOutput_1 + ") VALUES "
							+ extendInsertValueStmt.toString();

					pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1
							.prepareStatement(insert_tMysqlOutput_1);

					int row2CounttMysqlOutput_1 = 0;
					int counttMysqlOutput_1 = 0;

					for (BufferLine_tMysqlOutput_1 bufferLtMysqlOutput_1 : exInsertColValueListtMysqlOutput_1) {
						counttMysqlOutput_1 = row2CounttMysqlOutput_1 * 5 + 1;

						if (bufferLtMysqlOutput_1.FullDate != null) {
							// timestamp < min java date value (year 1) ||
							// timestamp > max mysql value (year 10000) => set
							// 0000-00-00 as date in MySQL
							date_tMysqlOutput_1 = bufferLtMysqlOutput_1.FullDate
									.getTime();
							if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
									|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
								pstmt_tMysqlOutput_1.setString(
							...
							pstmt_tMysqlOutput_1.setNull(counttMysqlOutput_1,
									java.sql.Types.DATE);
						...
						if (bufferLtMysqlOutput_1.DimDay == null) {
							pstmt_tMysqlOutput_1.setNull(counttMysqlOutput_1,
									java.sql.Types.VARCHAR);

						} else {

							pstmt_tMysqlOutput_1.setString(counttMysqlOutput_1,
									bufferLtMysqlOutput_1.DimDay);

						}

						counttMysqlOutput_1++;

						pstmt_tMysqlOutput_1.setInt(counttMysqlOutput_1,
								bufferLtMysqlOutput_1.DimWeek_NUM);

						counttMysqlOutput_1++;

						if (bufferLtMysqlOutput_1.DimMonth == null) {
							pstmt_tMysqlOutput_1.setNull(counttMysqlOutput_1,
									java.sql.Types.VARCHAR);
							...
							pstmt_tMysqlOutput_1.setString(counttMysqlOutput_1,
									bufferLtMysqlOutput_1.DimMonth);

						}

						counttMysqlOutput_1++;

						pstmt_tMysqlOutput_1.setLong(counttMysqlOutput_1,
								bufferLtMysqlOutput_1.DimYear);

						counttMysqlOutput_1++;

						row2CounttMysqlOutput_1++;
					}
					try {
						insertedCount_tMysqlOutput_1 = insertedCount_tMysqlOutput_1
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = now(),\nETL_info_table.record_count=1\nWHERE ETL_info_table.table_id = 8";
	...
	public static void main(String[] args) {
		final date_dimension date_dimensionClass = new date_dimension();

		int exitCode = date_dimensionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = date_dimension.class
					.getClassLoader().getResourceAsStream(
							"final_etl/date_dimension_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : date_dimension");
		}
...
/************************************************************************************************
 * 77974 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:01 PM PDT
 ************************************************************************************************/
