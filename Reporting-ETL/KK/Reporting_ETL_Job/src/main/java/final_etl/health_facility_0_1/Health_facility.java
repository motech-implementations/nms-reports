...
package final_etl.health_facility_0_1;
...
/**
 * Job: Health_facility Purpose: Health_block reporting table<br>
 * Description: Health_block reporting table generated using motech_data_services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class Health_facility implements TalendJob {
	...
	private final String jobName = "Health_facility";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Health_facility.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Health_facility.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_facility = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_facility = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Health_facility.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Health_facility.length == 0) {
						commonByteArray_FINAL_ETL_Health_facility = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Health_facility = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Health_facility, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_Health_facility, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_facility) {
	...
	public static class healthfacility_data_to_be_updatedStruct
			implements
			routines.system.IPersistableRow<healthfacility_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_facility = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_facility = new byte[0];
		...
		public String healthfacility_name;

		public String getHealthfacility_name() {
			return this.healthfacility_name;
		}

		public long healthblock_id;

		public long getHealthblock_id() {
			return this.healthblock_id;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final healthfacility_data_to_be_updatedStruct other = (healthfacility_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(healthfacility_data_to_be_updatedStruct other) {

			other.Id = this.Id;
			other.healthfacility_name = this.healthfacility_name;
			other.healthblock_id = this.healthblock_id;
			other.modificationDate = this.modificationDate;

		}

		public void copyKeysDataTo(healthfacility_data_to_be_updatedStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_facility) {
				...
				try {
					...
					this.healthfacility_name = readString(dis);

					this.healthblock_id = dis.readLong();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.healthfacility_name, dos);

				// long

				dos.writeLong(this.healthblock_id);
		...
		public String toString() {
			...
			sb.append(",healthfacility_name=" + healthfacility_name);
			sb.append(",healthblock_id=" + String.valueOf(healthblock_id));
		 ...
		 * Compare keys
		 */
		public int compareTo(healthfacility_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				healthfacility_data_to_be_updatedStruct healthfacility_data_to_be_updated = new healthfacility_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "healthfacility_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "healthfacility_dimension"
								+ "` WHERE `Id` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "healthfacility_dimension"
						+ "` (`Id`,`healthfacility_name`,`healthblock_id`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "healthfacility_dimension"
						+ "` SET `healthfacility_name` = ?,`healthblock_id` = ?,`modificationDate` = ? WHERE `Id` = ?";
				...
				healthfacility_data_to_be_updatedStruct healthfacility_data_to_be_updated_tmp = new healthfacility_data_to_be_updatedStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_3 = "select id, name, healthBlock_id_OID,modificationDate\nfrom nms_health_facilities\nWHERE creationDate>'"
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							row3.healthBlock_id_OID = 0;
						} else {

							if (rs_tMysqlInput_3.getObject(3) != null) {
								row3.healthBlock_id_OID = rs_tMysqlInput_3
										.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						{ // start of Var scope
							...
							healthfacility_data_to_be_updated = null;

							// # Output table :
							// 'healthfacility_data_to_be_updated'
							healthfacility_data_to_be_updated_tmp.Id = row3.id;
							healthfacility_data_to_be_updated_tmp.healthfacility_name = row3.name;
							healthfacility_data_to_be_updated_tmp.healthblock_id = row3.healthBlock_id_OID;
							healthfacility_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							healthfacility_data_to_be_updated = healthfacility_data_to_be_updated_tmp;
							// ###############################
						 ...
						 * [tMap_3 main ] stop
						 */
						// Start of branch "healthfacility_data_to_be_updated"
						if (healthfacility_data_to_be_updated != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1,
									healthfacility_data_to_be_updated.Id);
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (healthfacility_data_to_be_updated.healthfacility_name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													healthfacility_data_to_be_updated.healthfacility_name);
								}

								pstmtUpdate_tMysqlOutput_3
										.setLong(
												2,
												healthfacility_data_to_be_updated.healthblock_id);

								if (healthfacility_data_to_be_updated.modificationDate == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													3,
													healthfacility_data_to_be_updated.modificationDate);
								}
						...
						} // End of branch "healthfacility_data_to_be_updated"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from healthfacility_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from healthfacility_dimension)\nWHERE ETL_info_table.table_id = 6";
	...
	public static void main(String[] args) {
		final Health_facility Health_facilityClass = new Health_facility();

		int exitCode = Health_facilityClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Health_facility.class
					.getClassLoader().getResourceAsStream(
							"final_etl/health_facility_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Health_facility");
		}
...
/************************************************************************************************
 * 82271 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:03 PM PDT
 ************************************************************************************************/
