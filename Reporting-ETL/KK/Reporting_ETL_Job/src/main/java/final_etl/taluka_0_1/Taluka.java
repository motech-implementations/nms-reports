...
/**
 * Job: Taluka Purpose: taluka report table<br>
 * Description: taluka report table generated using motech_data_services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class Taluka implements TalendJob {
	...
	private final String jobName = "Taluka";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Taluka.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Taluka = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Taluka = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Taluka.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Taluka.length == 0) {
						commonByteArray_FINAL_ETL_Taluka = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Taluka = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Taluka, 0, length);
				strReturn = new String(commonByteArray_FINAL_ETL_Taluka, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Taluka) {
	...
	public static class taluka_data_to_be_updatedStruct implements
			routines.system.IPersistableRow<taluka_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_Taluka = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Taluka = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final taluka_data_to_be_updatedStruct other = (taluka_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(taluka_data_to_be_updatedStruct other) {

			other.Id = this.Id;
			other.taluka_name = this.taluka_name;
			other.district_id = this.district_id;
			other.modificationDate = this.modificationDate;

		}

		public void copyKeysDataTo(taluka_data_to_be_updatedStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Taluka) {
				...
				try {
					...
					this.taluka_name = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.taluka_name, dos);
		...
		public String toString() {
			...
			sb.append(",taluka_name=" + taluka_name);
		 ...
		 * Compare keys
		 */
		public int compareTo(taluka_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				taluka_data_to_be_updatedStruct taluka_data_to_be_updated = new taluka_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "taluka_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "taluka_dimension" + "` WHERE `Id` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "taluka_dimension"
						+ "` (`Id`,`taluka_name`,`district_id`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "taluka_dimension"
						+ "` SET `taluka_name` = ?,`district_id` = ?,`modificationDate` = ? WHERE `Id` = ?";
				...
				taluka_data_to_be_updatedStruct taluka_data_to_be_updated_tmp = new taluka_data_to_be_updatedStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_3 = "select id, name, district_id_OID ,modificationDate\nfrom nms_talukas\nWHERE creationDate>'"
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							row3.district_id_OID = 0;
						} else {

							if (rs_tMysqlInput_3.getObject(3) != null) {
								row3.district_id_OID = rs_tMysqlInput_3
										.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						{ // start of Var scope
							...
							taluka_data_to_be_updated = null;

							// # Output table : 'taluka_data_to_be_updated'
							taluka_data_to_be_updated_tmp.Id = row3.id;
							taluka_data_to_be_updated_tmp.taluka_name = row3.name;
							taluka_data_to_be_updated_tmp.district_id = row3.district_id_OID;
							taluka_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							taluka_data_to_be_updated = taluka_data_to_be_updated_tmp;
							// ###############################
						 ...
						 * [tMap_3 main ] stop
						 */
						// Start of branch "taluka_data_to_be_updated"
						if (taluka_data_to_be_updated != null) {
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (taluka_data_to_be_updated.taluka_name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													taluka_data_to_be_updated.taluka_name);
								}

								pstmtUpdate_tMysqlOutput_3.setLong(2,
										taluka_data_to_be_updated.district_id);

								if (taluka_data_to_be_updated.modificationDate != null) {
									date_tMysqlOutput_3 = taluka_data_to_be_updated.modificationDate
											.getTime();
						...
						} // End of branch "taluka_data_to_be_updated"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time =(SELECT MAX(modificationDate) from taluka_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from taluka_dimension)\nWHERE ETL_info_table.table_id = 3";
	...
	public static void main(String[] args) {
		final Taluka TalukaClass = new Taluka();

		int exitCode = TalukaClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Taluka.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/taluka_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Taluka");
		}
...
/************************************************************************************************
 * 83319 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:02 PM PDT
 ************************************************************************************************/
