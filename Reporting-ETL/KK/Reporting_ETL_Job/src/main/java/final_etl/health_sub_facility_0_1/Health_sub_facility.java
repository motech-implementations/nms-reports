...
package final_etl.health_sub_facility_0_1;
...
/**
 * Job: Health_sub_facility Purpose: Health_block reporting table<br>
 * Description: Health_block reporting table generated using motech_data_services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class Health_sub_facility implements TalendJob {
	...
	private final String jobName = "Health_sub_facility";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Health_sub_facility.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Health_sub_facility.this, new Object[] {
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_sub_facility = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_sub_facility = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Health_sub_facility.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Health_sub_facility.length == 0) {
						commonByteArray_FINAL_ETL_Health_sub_facility = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Health_sub_facility = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Health_sub_facility, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_Health_sub_facility, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_sub_facility) {
	...
	public static class healthSubFacility_data_to_be_updatedStruct
			implements
			routines.system.IPersistableRow<healthSubFacility_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_sub_facility = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_sub_facility = new byte[0];
		...
		public String healthsubfacility_name;

		public String getHealthsubfacility_name() {
			return this.healthsubfacility_name;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final healthSubFacility_data_to_be_updatedStruct other = (healthSubFacility_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(healthSubFacility_data_to_be_updatedStruct other) {

			other.Id = this.Id;
			other.healthsubfacility_name = this.healthsubfacility_name;
		...
		public void copyKeysDataTo(
				healthSubFacility_data_to_be_updatedStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_sub_facility) {
				...
				try {
					...
					this.healthsubfacility_name = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.healthsubfacility_name, dos);
		...
		public String toString() {
			...
			sb.append(",healthsubfacility_name=" + healthsubfacility_name);
		 ...
		 * Compare keys
		 */
		public int compareTo(healthSubFacility_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				healthSubFacility_data_to_be_updatedStruct healthSubFacility_data_to_be_updated = new healthSubFacility_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "healthsubfacility_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "healthsubfacility_dimension"
								+ "` WHERE `Id` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "healthsubfacility_dimension"
						+ "` (`Id`,`healthsubfacility_name`,`healthfacility_id`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "healthsubfacility_dimension"
						+ "` SET `healthsubfacility_name` = ?,`healthfacility_id` = ?,`modificationDate` = ? WHERE `Id` = ?";
				...
				healthSubFacility_data_to_be_updatedStruct healthSubFacility_data_to_be_updated_tmp = new healthSubFacility_data_to_be_updatedStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_3 = "select id, name, healthFacility_id_OID,modificationDate\nfrom nms_health_sub_facilities\nWHERE creationDate>'"
				...
				try {
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							row3.healthFacility_id_OID = 0;
						} else {

							if (rs_tMysqlInput_3.getObject(3) != null) {
								row3.healthFacility_id_OID = rs_tMysqlInput_3
										.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
						...
						{ // start of Var scope
							...
							healthSubFacility_data_to_be_updated = null;

							// # Output table :
							// 'healthSubFacility_data_to_be_updated'
							healthSubFacility_data_to_be_updated_tmp.Id = row3.id;
							healthSubFacility_data_to_be_updated_tmp.healthsubfacility_name = row3.name;
							healthSubFacility_data_to_be_updated_tmp.healthfacility_id = row3.healthFacility_id_OID;
							healthSubFacility_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							healthSubFacility_data_to_be_updated = healthSubFacility_data_to_be_updated_tmp;
							// ###############################
						...
						// Start of branch
						// "healthSubFacility_data_to_be_updated"
						if (healthSubFacility_data_to_be_updated != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1,
									healthSubFacility_data_to_be_updated.Id);
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (healthSubFacility_data_to_be_updated.healthsubfacility_name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													healthSubFacility_data_to_be_updated.healthsubfacility_name);
								}

								pstmtUpdate_tMysqlOutput_3
										.setLong(
												2,
												healthSubFacility_data_to_be_updated.healthfacility_id);

								if (healthSubFacility_data_to_be_updated.modificationDate == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													3,
													healthSubFacility_data_to_be_updated.modificationDate);
								}
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from healthsubfacility_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from healthsubfacility_dimension)\nWHERE ETL_info_table.table_id = 7";
	...
	public static void main(String[] args) {
		final Health_sub_facility Health_sub_facilityClass = new Health_sub_facility();

		int exitCode = Health_sub_facilityClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Health_sub_facility.class
					.getClassLoader().getResourceAsStream(
							"final_etl/health_sub_facility_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Health_sub_facility");
		}
...
/************************************************************************************************
 * 82723 characters generated by Talend Open Studio for Big Data on the May 20,
 * 2016 2:50:03 PM PDT
 ************************************************************************************************/
