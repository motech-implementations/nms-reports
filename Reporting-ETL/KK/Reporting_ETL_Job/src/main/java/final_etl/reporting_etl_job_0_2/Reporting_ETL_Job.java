...
package final_etl.reporting_etl_job_0_2;
...
/**
 * Job: Reporting_ETL_Job Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Reporting_ETL_Job implements TalendJob {
	...
	private final String jobName = "Reporting_ETL_Job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Reporting_ETL_Job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Reporting_ETL_Job.this, new Object[] { e,
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println("Kilkari ETL Started......................");
				System.out.println(new java.text.SimpleDateFormat(
						"yyyy-MM-dd HH:mm:ss").format(java.util.Calendar
						.getInstance().getTime()));
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info childJob_tRunJob_3 = new final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.dimenison_table_execution_0_1.Dimenison_Table_Execution childJob_tRunJob_1 = new final_etl.dimenison_table_execution_0_1.Dimenison_Table_Execution();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.measure_table_execution_0_1.Measure_Table_Execution childJob_tRunJob_2 = new final_etl.measure_table_execution_0_1.Measure_Table_Execution();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info childJob_tRunJob_4 = new final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info();
				// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println(new java.text.SimpleDateFormat(
						"yyyy-MM-dd HH:mm:ss").format(java.util.Calendar
						.getInstance().getTime()));
				System.out.println("Kilkari ETL Ended......................");
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info childJob_tRunJob_5 = new final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info();
				// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println(new java.text.SimpleDateFormat(
						...
						.getInstance().getTime()));
				System.out
						.println("Error occured in Kilkari Measure table execution, Please Refer log  printed above");
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info childJob_tRunJob_6 = new final_etl.log_etl_table_info_0_1.Log_Etl_Table_Info();
				// pass DataSources
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				System.out.println(new java.text.SimpleDateFormat(
						...
						.getInstance().getTime()));
				System.out
						.println("Error occured in Dimension table execution, Refer log printed above");
	...
	public static void main(String[] args) {
		final Reporting_ETL_Job Reporting_ETL_JobClass = new Reporting_ETL_Job();

		int exitCode = Reporting_ETL_JobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Reporting_ETL_Job.class
					.getClassLoader().getResourceAsStream(
							"final_etl/reporting_etl_job_0_2/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Reporting_ETL_Job");
		}
...
/************************************************************************************************
 * 63253 characters generated by Talend Open Studio for Big Data on the 18 July,
 * 2016 4:05:46 PM IST
 ************************************************************************************************/
