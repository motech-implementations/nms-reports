...
package final_etl.dimenison_table_execution_0_1;
...
/**
 * Job: Dimenison_Table_Execution Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Dimenison_Table_Execution implements TalendJob {
	...
	private final String jobName = "Dimenison_Table_Execution";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Dimenison_Table_Execution.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dimenison_Table_Execution.this,
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.date_dimension_0_1.date_dimension childJob_tRunJob_8 = new final_etl.date_dimension_0_1.date_dimension();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.time_dimension_0_1.time_dimension childJob_tRunJob_9 = new final_etl.time_dimension_0_1.time_dimension();
				// pass DataSources
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.state_0_1.State childJob_tRunJob_1 = new final_etl.state_0_1.State();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.district_0_1.District childJob_tRunJob_2 = new final_etl.district_0_1.District();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.taluka_0_1.Taluka childJob_tRunJob_7 = new final_etl.taluka_0_1.Taluka();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.village_0_1.Village childJob_tRunJob_6 = new final_etl.village_0_1.Village();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.health_block_0_1.Health_block childJob_tRunJob_3 = new final_etl.health_block_0_1.Health_block();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.health_facility_0_1.Health_facility childJob_tRunJob_4 = new final_etl.health_facility_0_1.Health_facility();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.health_sub_facility_0_1.Health_sub_facility childJob_tRunJob_5 = new final_etl.health_sub_facility_0_1.Health_sub_facility();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.channel_0_1.Channel childJob_tRunJob_10 = new final_etl.channel_0_1.Channel();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subsrciptionpack_0_1.SubsrciptionPack childJob_tRunJob_11 = new final_etl.subsrciptionpack_0_1.SubsrciptionPack();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_11:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_12Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.campaign_0_1.Campaign childJob_tRunJob_12 = new final_etl.campaign_0_1.Campaign();
				// pass DataSources
			...
			if (resumeEntryMethodName == null || globalResumeTicket) {
				resumeUtil
						.addLog("CHECKPOINT",
								"CONNECTION:SUBJOB_OK:tRunJob_12:OnSubjobOk",
								"", Thread.currentThread().getId() + "", "",
								"", "", "", "");
			}
	...
	public void tRunJob_13Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.operator_dimension_0_1.Operator_dimension childJob_tRunJob_13 = new final_etl.operator_dimension_0_1.Operator_dimension();
				// pass DataSources
				...
				if (null != talendDataSources_tRunJob_13) {
					...
					for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_tRunJob_13 : talendDataSources_tRunJob_13
						...
						dataSources_tRunJob_13.put(
								talendDataSourceEntry_tRunJob_13.getKey(),
								talendDataSourceEntry_tRunJob_13.getValue()
										.getRawDataSource());
					}
	...
	public static void main(String[] args) {
		final Dimenison_Table_Execution Dimenison_Table_ExecutionClass = new Dimenison_Table_Execution();

		int exitCode = Dimenison_Table_ExecutionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dimenison_Table_Execution.class
					.getClassLoader().getResourceAsStream(
							"final_etl/dimenison_table_execution_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Dimenison_Table_Execution");
		}
...
/************************************************************************************************
 * 94092 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:47 PM PDT
 ************************************************************************************************/
