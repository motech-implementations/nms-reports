...
package final_etl.health_block_0_1;
...
public class Health_block implements TalendJob {
	...
	private final String jobName = "Health_block";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Health_block.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_block = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_block = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Health_block.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Health_block.length == 0) {
						commonByteArray_FINAL_ETL_Health_block = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Health_block = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Health_block, 0, length);
				strReturn = new String(commonByteArray_FINAL_ETL_Health_block,
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_block) {
	...
	public static class healthblock_data_to_be_updatedStruct
			implements
			routines.system.IPersistableRow<healthblock_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_Health_block = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Health_block = new byte[0];
		...
		public String healthblock_name;

		public String getHealthblock_name() {
			return this.healthblock_name;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final healthblock_data_to_be_updatedStruct other = (healthblock_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(healthblock_data_to_be_updatedStruct other) {

			other.Id = this.Id;
			other.healthblock_name = this.healthblock_name;
			other.taluka_id = this.taluka_id;
			other.modificationDate = this.modificationDate;

		}

		public void copyKeysDataTo(healthblock_data_to_be_updatedStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Health_block) {
				...
				try {
					...
					this.healthblock_name = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.healthblock_name, dos);
		...
		public String toString() {
			...
			sb.append(",healthblock_name=" + healthblock_name);
		 ...
		 * Compare keys
		 */
		public int compareTo(healthblock_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_3Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				healthblock_data_to_be_updatedStruct healthblock_data_to_be_updated = new healthblock_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "healthblock_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "healthblock_dimension" + "` WHERE `Id` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "healthblock_dimension"
						+ "` (`Id`,`healthblock_name`,`taluka_id`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "healthblock_dimension"
						+ "` SET `healthblock_name` = ?,`taluka_id` = ?,`modificationDate` = ? WHERE `Id` = ?";
				...
				healthblock_data_to_be_updatedStruct healthblock_data_to_be_updated_tmp = new healthblock_data_to_be_updatedStruct();
				// ###############################
					...
					while (rs_tMysqlInput_3.next()) {
						...
						if (colQtyInRs_tMysqlInput_3 < 3) {
							...
							if (rs_tMysqlInput_3.getObject(3) != null) {
								row3.taluka_id = rs_tMysqlInput_3.getLong(3);
							} else {
								throw new RuntimeException(
										"Null value in non-Nullable column");
							}
						...
						{ // start of Var scope
							...
							healthblock_data_to_be_updated = null;

							// # Output table : 'healthblock_data_to_be_updated'
							healthblock_data_to_be_updated_tmp.Id = row3.id;
							healthblock_data_to_be_updated_tmp.healthblock_name = row3.name;
							healthblock_data_to_be_updated_tmp.taluka_id = row3.taluka_id;
							healthblock_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							healthblock_data_to_be_updated = healthblock_data_to_be_updated_tmp;
							// ###############################
						 ...
						 * [tMap_3 main ] stop
						 */
						// Start of branch "healthblock_data_to_be_updated"
						if (healthblock_data_to_be_updated != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1,
									healthblock_data_to_be_updated.Id);
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (healthblock_data_to_be_updated.healthblock_name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													healthblock_data_to_be_updated.healthblock_name);
								}

								pstmtUpdate_tMysqlOutput_3
										.setLong(
												2,
												healthblock_data_to_be_updated.taluka_id);

								if (healthblock_data_to_be_updated.modificationDate != null) {
									date_tMysqlOutput_3 = healthblock_data_to_be_updated.modificationDate
											.getTime();
						...
						} // End of branch "healthblock_data_to_be_updated"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT MAX(modificationDate) from healthblock_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from healthblock_dimension)\nWHERE ETL_info_table.table_id = 5";
	...
	public static void main(String[] args) {
		final Health_block Health_blockClass = new Health_block();

		int exitCode = Health_blockClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Health_block.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/health_block_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Health_block");
		}
...
/************************************************************************************************
 * 83842 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:46 PM PDT
 ************************************************************************************************/
