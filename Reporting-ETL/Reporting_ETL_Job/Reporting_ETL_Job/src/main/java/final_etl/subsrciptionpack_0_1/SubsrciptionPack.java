...
package final_etl.subsrciptionpack_0_1;
...
/**
 * Job: SubsrciptionPack Purpose: subsrciption_pack_dimension reporting table<br>
 * Description: subsrciption_pack_dimension reporting table genarated using motech data services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class SubsrciptionPack implements TalendJob {
	...
	private final String jobName = "SubsrciptionPack";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SubsrciptionPack.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SubsrciptionPack.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_SubsrciptionPack = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_SubsrciptionPack = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_SubsrciptionPack.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_SubsrciptionPack.length == 0) {
						commonByteArray_FINAL_ETL_SubsrciptionPack = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_SubsrciptionPack = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_SubsrciptionPack, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_SubsrciptionPack, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_SubsrciptionPack) {
	...
	public static class subsrciption_pack_dataStruct implements
			routines.system.IPersistableRow<subsrciption_pack_dataStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_SubsrciptionPack = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_SubsrciptionPack = new byte[0];
		...
		public String Subscription_Pack;

		public String getSubscription_Pack() {
			return this.Subscription_Pack;
		}

		public String Subscription_Pack_Alias;

		public String getSubscription_Pack_Alias() {
			return this.Subscription_Pack_Alias;
		}
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final subsrciption_pack_dataStruct other = (subsrciption_pack_dataStruct) obj;
		...
		public void copyDataTo(subsrciption_pack_dataStruct other) {

			other.Subscription_Pack_ID = this.Subscription_Pack_ID;
			other.Subscription_Pack = this.Subscription_Pack;
			other.Subscription_Pack_Alias = this.Subscription_Pack_Alias;
			other.messagesPerWeek = this.messagesPerWeek;
			other.modificationDate = this.modificationDate;

		}

		public void copyKeysDataTo(subsrciption_pack_dataStruct other) {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_SubsrciptionPack) {
				...
				try {
					...
					this.Subscription_Pack = readString(dis);

					this.Subscription_Pack_Alias = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.Subscription_Pack, dos);

				// String

				writeString(this.Subscription_Pack_Alias, dos);
		...
		public String toString() {
			...
			sb.append(",Subscription_Pack=" + Subscription_Pack);
			sb.append(",Subscription_Pack_Alias=" + Subscription_Pack_Alias);
		 ...
		 * Compare keys
		 */
		public int compareTo(subsrciption_pack_dataStruct other) {
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				subsrciption_pack_dataStruct subsrciption_pack_data = new subsrciption_pack_dataStruct();
				...
				String tableName_tMysqlOutput_1 = "subscription_pack_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "subscription_pack_dimension"
								+ "` WHERE `Subscription_Pack_ID` = ?");
				String insert_tMysqlOutput_1 = "INSERT INTO `"
						+ "subscription_pack_dimension"
						+ "` (`Subscription_Pack_ID`,`Subscription_Pack`,`Subscription_Pack_Alias`,`messagesPerWeek`,`modificationDate`) VALUES (?,?,?,?,?)";
				...
				String update_tMysqlOutput_1 = "UPDATE `"
						+ "subscription_pack_dimension"
						+ "` SET `Subscription_Pack` = ?,`Subscription_Pack_Alias` = ?,`messagesPerWeek` = ?,`modificationDate` = ? WHERE `Subscription_Pack_ID` = ?";
				...
				subsrciption_pack_dataStruct subsrciption_pack_data_tmp = new subsrciption_pack_dataStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_1 = "select id, name, type, messagesPerWeek ,modificationDate\nfrom nms_subscription_packs\nWHERE creationDate>'"
				...
				try {
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 3) {
							...
							row1.type = routines.system.JDBCUtil.getString(
									rs_tMysqlInput_1, 3, false);
						}
						...
						{ // start of Var scope
							...
							subsrciption_pack_data = null;

							// # Output table : 'subsrciption_pack_data'
							subsrciption_pack_data_tmp.Subscription_Pack_ID = row1.id;
							subsrciption_pack_data_tmp.Subscription_Pack = row1.type;
							subsrciption_pack_data_tmp.Subscription_Pack_Alias = row1.name;
							subsrciption_pack_data_tmp.messagesPerWeek = row1.messagesPerWeek;
							subsrciption_pack_data_tmp.modificationDate = row1.modificationDate;
							subsrciption_pack_data = subsrciption_pack_data_tmp;
							// ###############################
						 ...
						 * [tMap_1 main ] stop
						 */
						// Start of branch "subsrciption_pack_data"
						if (subsrciption_pack_data != null) {
							...
							pstmt_tMysqlOutput_1
									.setLong(
											1,
											subsrciption_pack_data.Subscription_Pack_ID);
							...
							if (checkCount_tMysqlOutput_1 > 0) {
								if (subsrciption_pack_data.Subscription_Pack == null) {
									...
									pstmtUpdate_tMysqlOutput_1
											.setString(
													1,
													subsrciption_pack_data.Subscription_Pack);
								}

								if (subsrciption_pack_data.Subscription_Pack_Alias == null) {
									...
									pstmtUpdate_tMysqlOutput_1
											.setString(
													2,
													subsrciption_pack_data.Subscription_Pack_Alias);
								}

								pstmtUpdate_tMysqlOutput_1.setInt(3,
										subsrciption_pack_data.messagesPerWeek);

								if (subsrciption_pack_data.modificationDate == null) {
									...
									pstmtUpdate_tMysqlOutput_1
											.setString(
													4,
													subsrciption_pack_data.modificationDate);
								}

								pstmtUpdate_tMysqlOutput_1
										.setLong(
												5 + count_tMysqlOutput_1,
												subsrciption_pack_data.Subscription_Pack_ID);
						...
						} // End of branch "subsrciption_pack_data"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT max(modificationDate) from subscription_pack_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from subscription_pack_dimension)\nWHERE ETL_info_table.table_id = 9";
	...
	public static void main(String[] args) {
		final SubsrciptionPack SubsrciptionPackClass = new SubsrciptionPack();

		int exitCode = SubsrciptionPackClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SubsrciptionPack.class
					.getClassLoader().getResourceAsStream(
							"final_etl/subsrciptionpack_0_1/contexts/"
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SubsrciptionPack");
		}
...
/************************************************************************************************
 * 83819 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:47 PM PDT
 ************************************************************************************************/
