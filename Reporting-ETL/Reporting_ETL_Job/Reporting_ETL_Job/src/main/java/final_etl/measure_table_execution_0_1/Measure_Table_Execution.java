...
package final_etl.measure_table_execution_0_1;
...
/**
 * Job: Measure_Table_Execution Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Measure_Table_Execution implements TalendJob {
	...
	private final String jobName = "Measure_Table_Execution";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Measure_Table_Execution.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Measure_Table_Execution.this,
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subscribers_0_1.Subscribers childJob_tRunJob_1 = new final_etl.subscribers_0_1.Subscribers();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subscriptions3_0_1.Subscriptions3 childJob_tRunJob_2 = new final_etl.subscriptions3_0_1.Subscriptions3();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subscriber_call_measure_0_1.Subscriber_call_measure childJob_tRunJob_3 = new final_etl.subscriber_call_measure_0_1.Subscriber_call_measure();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subscriber_call_measure_obd_0_2.Subscriber_call_measure_OBD childJob_tRunJob_5 = new final_etl.subscriber_call_measure_obd_0_2.Subscriber_call_measure_OBD();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.subscription_operator_update_0_1.Subscription_Operator_Update childJob_tRunJob_7 = new final_etl.subscription_operator_update_0_1.Subscription_Operator_Update();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				final_etl.campaign_schedule_0_1.Campaign_Schedule childJob_tRunJob_4 = new final_etl.campaign_schedule_0_1.Campaign_Schedule();
				// pass DataSources
	...
	public static void main(String[] args) {
		final Measure_Table_Execution Measure_Table_ExecutionClass = new Measure_Table_Execution();

		int exitCode = Measure_Table_ExecutionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Measure_Table_Execution.class
					.getClassLoader().getResourceAsStream(
							"final_etl/measure_table_execution_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Measure_Table_Execution");
		}
...
/************************************************************************************************
 * 52576 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:48 PM PDT
 ************************************************************************************************/
