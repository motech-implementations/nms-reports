...
package final_etl.subscriber_call_measure_0_1;
...
/**
 * Job: Subscriber_call_measure Purpose: Subscriber_call_measure<br>
 * Description: Subscriber_call_measure job populate call data from inbox and CDR <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class Subscriber_call_measure implements TalendJob {
	...
	private final String jobName = "Subscriber_call_measure";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Subscriber_call_measure.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Subscriber_call_measure.this,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Subscriber_call_measure = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Subscriber_call_measure = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Subscriber_call_measure.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Subscriber_call_measure.length == 0) {
						commonByteArray_FINAL_ETL_Subscriber_call_measure = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Subscriber_call_measure = new byte[2 * length];
					}
				}
				dis.readFully(
						commonByteArray_FINAL_ETL_Subscriber_call_measure, 0,
						length);
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Subscriber_call_measure) {
	...
	public static class row1Struct implements
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Subscriber_call_measure) {
				...
				try {
					...
					this.Call_Status = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.Call_Status, dos);
		...
		public String toString() {
			...
			sb.append(",Subscription_Pack_ID="
					+ String.valueOf(Subscription_Pack_ID));
			sb.append(",Call_Status=" + String.valueOf(Call_Status));
	...
	public void tMysqlInput_1Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				int updateKeyCount_tMysqlOutput_1 = 9;
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_1 = conn_tMysqlOutput_1
						.prepareStatement("SELECT COUNT(1) FROM `"
								...
								+ "` WHERE `Subscription_ID` = ? AND `Operator_ID` = ? AND `Subscription_Pack_ID` = ? AND `Campaign_ID` = ? AND `Start_Date_ID` = ? AND `End_Date_ID` = ? AND `Start_Time_ID` = ? AND `End_Time_ID` = ? AND `Call_Start_Time` = ?");
				...
				String update_tMysqlOutput_1 = "UPDATE `"
						+ "subscriber_call_measure"
						+ "` SET `State_ID` = ?,`Call_Status` = ?,`Duration` = ?,`Service_Option` = ?,`Percentage_Listened` = ?,`Call_Source` = ?,`Subscription_Status` = ?,`Duration_In_Pulse` = ?,`Call_End_Time` = ?,`Attempt_Number` = ?,`Subscription_Start_Date` = ?,`msg_duration` = ?,`modificationDate` = ? WHERE `Subscription_ID` = ? AND `Operator_ID` = ? AND `Subscription_Pack_ID` = ? AND `Campaign_ID` = ? AND `Start_Date_ID` = ? AND `End_Date_ID` = ? AND `Start_Time_ID` = ? AND `End_Time_ID` = ? AND `Call_Start_Time` = ?";
					...
					while (rs_tMysqlInput_1.next()) {
						...
						if (colQtyInRs_tMysqlInput_1 < 4) {
							...
							if (rs_tMysqlInput_1.getObject(4) != null) {
								row1.Call_Status = rs_tMysqlInput_1.getInt(4);
							} else {
								row1.Call_Status = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 7) {
							...
							if (rs_tMysqlInput_1.getString(7) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.End_Date = rs_tMysqlInput_1
											.getTimestamp(7);
								} else {
									row1.End_Date = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.End_Date = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 8) {
							...
							if (rs_tMysqlInput_1.getString(8) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.Start_Time = rs_tMysqlInput_1
											.getTimestamp(8);
								} else {
									row1.Start_Time = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.Start_Time = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 9) {
							...
							if (rs_tMysqlInput_1.getString(9) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_1)) {
									row1.End_Time = rs_tMysqlInput_1
											.getTimestamp(9);
								} else {
									row1.End_Time = (java.util.Date) year0_tMysqlInput_1
											.clone();
								}
							} else {
								row1.End_Time = null;
						...
						if (colQtyInRs_tMysqlInput_1 < 10) {
							...
							if (rs_tMysqlInput_1.getObject(10) != null) {
								row1.Duration = rs_tMysqlInput_1.getInt(10);
							} else {
								row1.Duration = null;
							}
						}
						...
						if (colQtyInRs_tMysqlInput_1 < 14) {
							...
							row1.Subscription_Pack_Name = routines.system.JDBCUtil
									.getString(rs_tMysqlInput_1, 14, false);
						}
						...
						{ // start of Var scope
							...
							inbox_call_measure_data_tmp.Call_Source = "INBOX";
							...
							inbox_call_measure_data_tmp.Call_Start_Time = row1.Start_Time;
							inbox_call_measure_data_tmp.Call_End_Time = row1.End_Time;
							inbox_call_measure_data_tmp.Attempt_Number = 0;
							inbox_call_measure_data_tmp.Subscription_Start_Date = row1.Subscription_Start_Date;
							inbox_call_measure_data_tmp.msg_duration = 0;
						...
						if (inbox_call_measure_data != null) {
							...
							if (checkCount_tMysqlOutput_1 > 0) {
								if (inbox_call_measure_data.State_ID == null) {
									...
									pstmtUpdate_tMysqlOutput_1.setLong(1,
								...
								if (inbox_call_measure_data.Subscription_Start_Date != null) {
									...
									if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
											|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
										pstmtUpdate_tMysqlOutput_1.setString(
								...
								pstmtUpdate_tMysqlOutput_1
										.setLong(
												14 + count_tMysqlOutput_1,
												inbox_call_measure_data.Subscription_ID);

								pstmtUpdate_tMysqlOutput_1.setLong(
										15 + count_tMysqlOutput_1,
										inbox_call_measure_data.Operator_ID);

								pstmtUpdate_tMysqlOutput_1
										.setLong(
												16 + count_tMysqlOutput_1,
												inbox_call_measure_data.Subscription_Pack_ID);
								...
								pstmtUpdate_tMysqlOutput_1.setInt(
										19 + count_tMysqlOutput_1,
										inbox_call_measure_data.End_Date_ID);

								pstmtUpdate_tMysqlOutput_1.setInt(
										20 + count_tMysqlOutput_1,
										inbox_call_measure_data.Start_Time_ID);

								pstmtUpdate_tMysqlOutput_1.setInt(
										21 + count_tMysqlOutput_1,
										inbox_call_measure_data.End_Time_ID);

								if (inbox_call_measure_data.Call_Start_Time != null) {
									pstmtUpdate_tMysqlOutput_1
											.setTimestamp(
													22 + count_tMysqlOutput_1,
													new java.sql.Timestamp(
															inbox_call_measure_data.Call_Start_Time
																	.getTime()));
								} else {
								...
								pstmtInsert_tMysqlOutput_1.setLong(2,
										inbox_call_measure_data.Operator_ID);
								...
								pstmtInsert_tMysqlOutput_1.setLong(4,
										inbox_call_measure_data.Campaign_ID);

								pstmtInsert_tMysqlOutput_1.setInt(5,
										inbox_call_measure_data.Start_Date_ID);

								pstmtInsert_tMysqlOutput_1.setInt(6,
										inbox_call_measure_data.End_Date_ID);

								pstmtInsert_tMysqlOutput_1.setInt(7,
										inbox_call_measure_data.Start_Time_ID);

								pstmtInsert_tMysqlOutput_1.setInt(8,
										inbox_call_measure_data.End_Time_ID);
								...
								if (inbox_call_measure_data.State_ID == null) {
									...
									pstmtInsert_tMysqlOutput_1.setLong(9,
											inbox_call_measure_data.State_ID);
								}
								...
								if (inbox_call_measure_data.Subscription_Status == null) {
									pstmtInsert_tMysqlOutput_1.setNull(15,
											java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tMysqlOutput_1
											.setString(
								...
								if (inbox_call_measure_data.Duration_In_Pulse == null) {
									pstmtInsert_tMysqlOutput_1.setNull(16,
											java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tMysqlOutput_1
											.setInt(16,
								...
								if (inbox_call_measure_data.Call_Start_Time != null) {
									...
									if (date_tMysqlOutput_1 < year1_tMysqlOutput_1
											|| date_tMysqlOutput_1 >= year10000_tMysqlOutput_1) {
										pstmtInsert_tMysqlOutput_1.setString(
									...
									pstmtInsert_tMysqlOutput_1.setNull(17,
											java.sql.Types.DATE);
								}
								...
								if (inbox_call_measure_data.Call_End_Time != null) {
									...
									pstmtInsert_tMysqlOutput_1.setNull(18,
											java.sql.Types.DATE);
								}

								if (inbox_call_measure_data.Attempt_Number == null) {
									pstmtInsert_tMysqlOutput_1.setNull(19,
											java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tMysqlOutput_1
											.setInt(19,
								...
								if (inbox_call_measure_data.Subscription_Start_Date != null) {
									...
									pstmtInsert_tMysqlOutput_1.setNull(20,
											java.sql.Types.DATE);
								}

								if (inbox_call_measure_data.msg_duration == null) {
									pstmtInsert_tMysqlOutput_1.setNull(21,
											java.sql.Types.INTEGER);
								} else {
									pstmtInsert_tMysqlOutput_1
											.setInt(21,
								...
								if (inbox_call_measure_data.modificationDate == null) {
									pstmtInsert_tMysqlOutput_1.setNull(22,
											java.sql.Types.VARCHAR);
								} else {
									pstmtInsert_tMysqlOutput_1
											.setString(
	...
	public static void main(String[] args) {
		final Subscriber_call_measure Subscriber_call_measureClass = new Subscriber_call_measure();

		int exitCode = Subscriber_call_measureClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Subscriber_call_measure.class
					.getClassLoader().getResourceAsStream(
							"final_etl/subscriber_call_measure_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Subscriber_call_measure");
		}
...
/************************************************************************************************
 * 118439 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:48 PM PDT
 ************************************************************************************************/
