...
/**
 * Job: State Purpose: state_dimension reporting table<br>
 * Description: state_dimension reporting table created using motech_data_services <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status DEV
 */
public class State implements TalendJob {
	...
	private final String jobName = "State";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(State.this, new Object[] { e,
	...
	public static class row4Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_State = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_State = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_State.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_State.length == 0) {
						commonByteArray_FINAL_ETL_State = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_State = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_State, 0, length);
				strReturn = new String(commonByteArray_FINAL_ETL_State, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_State) {
	...
	public static class State_data_to_be_updatedStruct implements
			routines.system.IPersistableRow<State_data_to_be_updatedStruct> {
		final static byte[] commonByteArrayLock_FINAL_ETL_State = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_State = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final State_data_to_be_updatedStruct other = (State_data_to_be_updatedStruct) obj;
		...
		public void copyDataTo(State_data_to_be_updatedStruct other) {
		...
		public void copyKeysDataTo(State_data_to_be_updatedStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(State_data_to_be_updatedStruct other) {
	...
	public void tMysqlInput_2Process(
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				State_data_to_be_updatedStruct State_data_to_be_updated = new State_data_to_be_updatedStruct();
				...
				String tableName_tMysqlOutput_3 = "state_dimension";
				...
				java.sql.PreparedStatement pstmt_tMysqlOutput_3 = conn_tMysqlOutput_3
						.prepareStatement("SELECT COUNT(1) FROM `"
								+ "state_dimension" + "` WHERE `State_ID` = ?");
				String insert_tMysqlOutput_3 = "INSERT INTO `"
						+ "state_dimension"
						+ "` (`State_ID`,`State_Name`,`CREATED_DATE`,`modificationDate`) VALUES (?,?,?,?)";
				...
				String update_tMysqlOutput_3 = "UPDATE `"
						+ "state_dimension"
						+ "` SET `State_Name` = ?,`CREATED_DATE` = ?,`modificationDate` = ? WHERE `State_ID` = ?";
				...
				State_data_to_be_updatedStruct State_data_to_be_updated_tmp = new State_data_to_be_updatedStruct();
				// ###############################
				...
				String dbquery_tMysqlInput_2 = "select id, name, creationDate,modificationDate \nfrom nms_states\nWHERE creationDate>'"
					...
					while (rs_tMysqlInput_2.next()) {
						...
						if (colQtyInRs_tMysqlInput_2 < 1) {
							...
							if (rs_tMysqlInput_2.getObject(1) != null) {
								row3.id = rs_tMysqlInput_2.getLong(1);
							} else {
								throw new RuntimeException(
						...
						if (colQtyInRs_tMysqlInput_2 < 3) {
							...
							if (rs_tMysqlInput_2.getString(3) != null) {
								...
								if (!("0000-00-00")
										...
										&& !("0000-00-00 00:00:00")
												.equals(dateString_tMysqlInput_2)) {
									row3.creationDate = rs_tMysqlInput_2
											.getTimestamp(3);
								} else {
									row3.creationDate = (java.util.Date) year0_tMysqlInput_2
											.clone();
								}
							} else {
								row3.creationDate = null;
						...
						{ // start of Var scope
							...
							State_data_to_be_updated = null;

							// # Output table : 'State_data_to_be_updated'
							State_data_to_be_updated_tmp.State_ID = row3.id;
							State_data_to_be_updated_tmp.State_Name = row3.name;
							State_data_to_be_updated_tmp.CREATED_DATE = row3.creationDate;
							State_data_to_be_updated_tmp.modificationDate = row3.modificationDate;
							State_data_to_be_updated = State_data_to_be_updated_tmp;
							// ###############################
						 ...
						 * [tMap_3 main ] stop
						 */
						// Start of branch "State_data_to_be_updated"
						if (State_data_to_be_updated != null) {
							...
							pstmt_tMysqlOutput_3.setLong(1,
									State_data_to_be_updated.State_ID);
							...
							if (checkCount_tMysqlOutput_3 > 0) {
								if (State_data_to_be_updated.State_Name == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													1,
													State_data_to_be_updated.State_Name);
								}

								if (State_data_to_be_updated.CREATED_DATE != null) {
									date_tMysqlOutput_3 = State_data_to_be_updated.CREATED_DATE
											.getTime();
								...
								if (State_data_to_be_updated.modificationDate == null) {
									...
									pstmtUpdate_tMysqlOutput_3
											.setString(
													3,
													State_data_to_be_updated.modificationDate);
								}
						...
						} // End of branch "State_data_to_be_updated"
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "UPDATE ETL_info_table SET ETL_info_table.last_etl_time = (SELECT MAX(modificationDate) from state_dimension),\nETL_info_table.record_count=(SELECT COUNT(*) from state_dimension)\nWHERE ETL_info_table.table_id = 1";
	...
	public static void main(String[] args) {
		final State StateClass = new State();

		int exitCode = StateClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = State.class.getClassLoader()
					.getResourceAsStream(
							"final_etl/state_0_1/contexts/" + contextStr
									+ ".properties");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : State");
		}
...
/************************************************************************************************
 * 83415 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:45 PM PDT
 ************************************************************************************************/
