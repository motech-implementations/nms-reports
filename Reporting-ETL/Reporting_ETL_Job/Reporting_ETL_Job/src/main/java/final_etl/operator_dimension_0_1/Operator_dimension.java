...
package final_etl.operator_dimension_0_1;
...
/**
 * Job: Operator_dimension Purpose: Operator_dimension<br>
 * Description: Operator_dimension Job populate pre defined operators as per SRS Document <br>
 * @author user@talend.com
 * @version 6.1.1.20151214_1327
 * @status 
 */
public class Operator_dimension implements TalendJob {
	...
	private final String jobName = "Operator_dimension";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Operator_dimension.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Operator_dimension.this, new Object[] { e,
	...
	public static class row3Struct implements
		...
		final static byte[] commonByteArrayLock_FINAL_ETL_Operator_dimension = new byte[0];
		static byte[] commonByteArray_FINAL_ETL_Operator_dimension = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_FINAL_ETL_Operator_dimension.length) {
					if (length < 1024
							&& commonByteArray_FINAL_ETL_Operator_dimension.length == 0) {
						commonByteArray_FINAL_ETL_Operator_dimension = new byte[1024];
					} else {
						commonByteArray_FINAL_ETL_Operator_dimension = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_FINAL_ETL_Operator_dimension, 0,
						length);
				strReturn = new String(
						commonByteArray_FINAL_ETL_Operator_dimension, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_FINAL_ETL_Operator_dimension) {
	...
	public void tMysqlRow_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeEntryMethodName == null || resumeIt || globalResumeTicket) {// start
				...
				query_tMysqlRow_1 = "INSERT INTO `ananya_kilkari`.`operator_dimension` (`operator_code`,`Operator`,`DW_LastUpdatedDtim`) \nVALUES ('D','Aircel',now()),	 \n('A','Airtel',now()),		 \n('B','BSNL',now()),	 \n('L','BPL',now()),\n('C','Datacom Solutions',now()),	 \n('H','HFCL Infotel',now()),\n('I','Idea',now()),	 \n('M','MTNL',now()),	 \n('R','Reliance GSM',now()),	 \n('E','Reliance CDMA',now()),	 \n('S','S. Tel',now()),\n('Y','Shyam Telecom',now()),	 \n('P','Spice',now()),\n('W','Swan Telecom',now()),\n('T','Tata Docomo',now()),	 \n('U','Uninor',now()),	 \n('V','Vodafone',now()),	 \n('9','Unknown',now())\nON DUPLICATE KEY UPDATE    \nOperator=VALUES(Operator), \nDW_LastUpdatedDtim=VALUES(DW_LastUpdatedDtim);\n";
	...
	public static void main(String[] args) {
		final Operator_dimension Operator_dimensionClass = new Operator_dimension();

		int exitCode = Operator_dimensionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Operator_dimension.class
					.getClassLoader().getResourceAsStream(
							"final_etl/operator_dimension_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : Operator_dimension");
		}
...
/************************************************************************************************
 * 40507 characters generated by Talend Open Studio for Big Data on the May 17,
 * 2016 4:00:47 PM PDT
 ************************************************************************************************/
